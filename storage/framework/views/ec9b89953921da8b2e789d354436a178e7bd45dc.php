...
<header id="header" class="site-header header-scrolled position-fixed text-black bg-light">
    <nav id="header-nav" class="navbar navbar-expand-lg px-3 mb-3">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo e(route('page',['name'=>'index'])); ?>">
                <img src="<?php echo e(asset('images/main-logo.png')); ?>" class="logo">
            </a>
                    ...
                    <ul id="navbar"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="<?php echo e(route('page',['name'=>'shopping_cart'])); ?>"
                        ...
                        <li class="nav-item">
                            <div class="user-items ps-5">
                                <ul class="d-flex justify-content-end list-unstyled">
                                    ...
                                    <li class="pe-3">
                                        <a href="<?php echo e(route('page',['name'=>'login'])); ?>">
                                            <svg class="user">
...
<?php /**PATH E:\Nhom8_ST5_BE2_NH23-24\resources\views/nav.blade.php ENDPATH**/ ?>