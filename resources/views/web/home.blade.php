    ...
    <section class=" container section section-highlights" data-anim-scroll-group="Highlights"
        ...
        <div class="responsive-content">
            <div class="responsive-content-viewport-content">
                ...
                <h2 class="section-header-headline typography-site-headline" class="large-show medium-inline small-hide"><b>MiniStore</b></h2>
                    </div>
                        ...
                        <div class="item-container">
                            <div id="media-gallery-item-1"
                                ...
                                <figure role="img" class="gallery-figure loaded paused static-fallback-only"
                                    ...
                                    <img class="positioned-media-element media" id="media-gallery-video-1" preload="none" alt="banner" alt="Banner" playsinline="" muted=""></img>
                            ...
                            <div id="media-gallery-item-2"
                                ...
                                aria-labelledby="media-gallery-item-2-trigger"
                                data-original-aria-hidden="" aria-hidden="true">
                                <p class="caption typography-site-highlights-headline" style="color: black; margin-left: 500px; margin-top: 100px; line-height: 80px; text-align: center;">
                                    SMART WATCH <br>
                            ...
                            <div id="media-gallery-item-3"
                                ...
                                <figure role="img" class="gallery-figure loaded paused static-fallback-only"
                                    ...
                                    <video class="positioned-media-element media" id="media-gallery-video-3" preload="none" playsinline="" muted="" src=""></video>
                ...
                <div class="col-lg-4 col-md-3 pb-5 quality">
                    <div class="icon-box d-flex">
                        ...
                        <div class="icon-box-content">
                            ...
                            <div class="overlay">
                                <strong>🎯 1 Year:</strong> for all hardware parts of the iPhone and included accessories, starting from the date the device is activated. <br>
                                <strong>🎯 First 3 months:</strong> phone support warranty. <br>
                                <strong>🎯 Remaining 9 months:</strong> warranty at Apple Authorized Service Centers in Vietnam.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="icon-box d-flex">
                        ...
                        <div class="icon-box-content">
                            ...
                            <div class="overlay">
                                ...
                                <a href="https://fptshop.com.vn/dien-thoai/apple-iphone" style="font-size: 30px">FPT Shop</a><br>
                                <a href="https://fptshop.com.vn/dien-thoai/apple-iphone" style="font-size: 30px">Thegioididong</a><br>
                                ...
                                <div class="swiper-slide product-list">
                                    <div class="image-holder">
                                        <a href="{{ route('detail', ['maSP' => $row->sanphams->maSP]) }}">
                                            <img src="{{ asset( $row->anhDaiDien) }}" alt="product-item" class="img-fluid">
                                        </a>
                                    </div>
                                    ...
                                    <div>
                                        <h6>
                                            @if(!empty($row->giaBan))
                                                <span><i class="bi bi-tags"></i><strike id="giaban">{{ number_format($row->giaBan) }} đ</strike></span>
                                            @else
                                                <div id="giaban">{{ number_format($row->giaBan) }} đ</div>
                                            @endif
                                        </h6>
...
, function(e, t, i) {
    "use strict";
    var s, n = i(8).EventEmitterMicro, r = i(47), a = i(65);
    function o(e) {
        e = e || {},
        n.call(this),
        this.id = a.getNewID(),
...
, function(e, t, i) {
    ...
    class c extends r.default {
        ...
        destroy() {
            ...
            (0,
            n.default)((()=>{
                this.featureDetect && this.featureDetect !== l.FEATURE_ENHANCED && this.gum && this.anim.forceUpdate(),
                super.destroy()
            }
            )))
        }
        ...
        async unenhanceFeatureClass() {
            this.featureDetect && this.featureDetect !== l.FEATURE_ENHANCED && await h.removeFeatureDetectClass(this.featureDetect),
            (0,
        ...
        setUnenhanceViewports() {
            ...
            h.setupViewportTracker({
                ...
                this.pageXp ? this._onUnenhancePageXpFeature("enhanced-xp:invalid-vp") : this.destroy(),
...
, function(e, t, i) {
    ...
    e.exports = "undefined" == typeof window ? new p : window.AC.SharedInstance.share("AnimSystem", c.major, p),
    e.exports.default = e.exports
}
, function(e, t, i) {
    "use strict";
                    ...
                    void 0 === this.controller.tweenProps[t] || !this.controller._ownerIsElement) {
                        ...
                        if (!h && this.controller._ownerIsElement)
                            if (o || p.includes(t)) {
                                ...
                                _.includes(t) && (h = new n(a,s.KeyframeDefaults.epsilon,this.snapAtCreation,t,e.round,l),
        ...
        async _onPlayKeyframeEnter(e) {
            ...
            this._inFrame))
                try {
                    ...
                    this.media.el.error || this.media.el.readyState === HTMLMediaElement.HAVE_NOTHING || (this.componentEl.classList.add(a.FALLBACK_CLASSNAME),
                    this.destroy())
                }
        }
        destroy() {
            this._playKeyframe && !this._playKeyframe.destroyed && (this._playKeyframe.controller.off(`${this._playKeyframe.event}:enter`, this._onPlayKeyframeEnter),
    ...
    class p extends r.default {
        ...
        injectPluginsByAttribute() {
            if (!this.productPagePlugins)
                throw Error("InlineMedia: injectPluginsByAttribute(): this.productPagePlugins must be assigned");
        ...
        destroy() {
            this.mediaInstance && !this.mediaInstance[0]._destroyed && (this.mediaInstance[0].off(c.EVT_TIMEOUT, this.mediaTimeout),
...
, function(e, t, i) {
    ...
    class c extends n.default {
        constructor() {
            ...
            this.id = e.id || this.el.id || this.el.dataset.inlineMediaId || "inlineMedia-" + d++;
...
, function(e, t, i) {
    ...
    class o extends n.Plugin {
        constructor(e) {
            ...
            this._rangeKeyframe.controller.on(`${this._rangeKeyframe.event}:enter`, this._onRangeKeyframeEnter)
        }
        mounted() {
            this.isAtLeastSafari15minor5 = document.documentElement.classList.contains("safari-15-5-or-up"),
        ...
        applyObjectFitFix() {
            this.isAtLeastSafari15minor5 && (this._anim.on("ON_RESIZE_IMMEDIATE", this._onResizeImmediate),
            this.removeObjectFitStyles(),
        ...
        _onResizeImmediate() {
            "loading-empty" !== this.media.loadingState && "loading-error" !== this.media.loadingState && (this._anim.off("ON_RESIZE_IMMEDIATE", this._onResizeImmediate),
...
, function(e, t, i) {
    ...
    class r extends n.default {
        destroy() {
            this._loadKeyframe && !this.loadKeyframe.destroyed && (this._loadKeyframe.controller.off(`${this._loadKeyframe.event}:enter`, this._onLoadKeyframeEnter),
            this._loadKeyframe.controller.off(`${this._loadKeyframe.event}:exit`, this._onLoadKeyframeExit))
        }
    }
    t.default = r
    ...
    class l extends n.default {
            ...
            if (this.viewerReady) {
                ...
                this.colorNav.querySelectorAll("input").forEach((e=>{
                    ...
                    if (i[t.dataset.viewerValue])
                        return void e.setAttribute("aria-label", i[t.dataset.viewerValue]);
                ...
                this.sizeNav.querySelectorAll("input").forEach((t=>{
                    ...
                    if (i[e.dataset.viewerValue])
                        return void t.setAttribute("aria-label", i[e.dataset.viewerValue]);
                    const s = document.createElement("div")
                      , n = this.viewerLabel.querySelector(`[data-color-value=${e.dataset.viewerValue}][data-size-value=${t.dataset.viewerValue}]`);
                    if (n) {
                        s.innerHTML = n ? n.innerHTML : null;
        ...
        _onDrag(e) {
            ...
            this.dragDrawId = a((()=>{
                ...
                this.sizeOptions[this.nextIndex].dispatchEvent(this.changeEvent),
                this.target = 0,
                this.bubbleHintOffset = 0) : (this.target < -56 || this.swipeVelocity < -50) && this.sizeOptions[this.prevIndex] ? (this.sizeOptions[this.prevIndex].checked = !0,
                this.sizeOptions[this.prevIndex].dispatchEvent(this.changeEvent),
                this.target = 0,
                this.bubbleHintOffset = 0) : (this.target > 0 && this.sizeOptions[this.nextIndex] || this.target < 0 && this.sizeOptions[this.prevIndex]) && (this.bubbleHintOffset = this.target / 56 * 4,
                this.aapOffset = 0,
        ...
        _getBounds() {
            ...
            this.viewerReady) {
                ...
                e.forEach((e=>{
                    "1" === this.ltr ? e.style.setProperty("--option-offset", `${e.parentNode.offsetLeft}px`) : e.style.setProperty("--option-offset", Math.floor(e.parentNode.parentNode.getBoundingClientRect().right - e.parentNode.getBoundingClientRect().right) - 1 + "px"),
    ...
    class D {
        ...
        factor() {
            ...
            if (this.currentToken.type === g || this.currentToken.type === E) {
                ...
                if (this.pos += 1,
                b.OPERATOR.test(this.currentToken.value) || this.currentToken.type === u || this.currentToken.type === y || this.currentToken.type === v)
                    return e;
...
, function(e, t, i) {
    ...
    function h(e) {
        ...
        c[0][2] > c[2][0] && (t[1] = -t[1]),
        c[1][0] > c[0][1] && (t[2] = -t[2]),
        f = t[0] < .001 && t[0] >= 0 && t[1] < .001 && t[1] >= 0 ? [0, 0, n(180 * Math.atan2(c[0][1], c[0][0]) / Math.PI)] : function(e) {
            const [t,i,r,a] = e
              , o = t * t
              , l = i * i
              , h = r * r
    ...
    class o extends r.default {
        ...
        focusOn(e) {
            if (e.hasAttribute(a)) {
                ...
                setTimeout((()=>{
                    e.hasOwnProperty("_focusExpressionLast") && this._lastPosition > n.default.parse(e._focusExpression, t) ? (window.scrollTo(0, n.default.parse(e._focusExpressionLast, t)),
                    this._lastPosition = n.default.parse(e._focusExpressionLast, t)) : (window.scrollTo(0, n.default.parse(e._focusExpression, t)),
      ...
      , _ = {
        ...
        _executePreloadStrategy() {
            ...
            "string" == typeof e && e.split(/,\s*/).forEach((e=>{
                ...
                if (!t)
                    throw new Error(`"${e}" is not a valid preload-strategy. Please select from any of the following values: ${Object.keys(this._preloadStrategies).join(", ")}`);
                t()
            }
            ))
        },
        ...
        mounted() {
            this.on(this.model.Events.ITEM_CHANGE_COMPLETED, (e=>{
                ...
                this.lastInteractionEvent && (this.lastInteractionEvent.type ? t = {
                    ...
                    mouseup: "swipe",
                    click: "link"
                }[this.lastInteractionEvent.type] : this.lastInteractionEvent.event && (t = this.lastInteractionEvent.event)),
                t || (t = "unknown");
                let i = null;
...
, function(e, t, i) {
    ...
    e.exports = {
        mounted() {
            ...
            this.onSlideChangeCompleted((e=>{
                e.exited && e.exited.index === e.entered.index || (this.getMediaGalleryItem(e.entered.index).enterSpotlightPosition(),
...
, function(e, t, i) {
    "use strict";
    var s, n = i(14), r = i(8).EventEmitterMicro;
    function a(e, t) {
        r.call(this),
        t = t || {},
        this._fps = e || 0,
...
, function(e, t, i) {
    ...
    t.default = function(e, t) {
        ...
        if (!i)
            return s.DevLogger.warn("The following nested element does not appear to be in a L2Modal", t),
            null;
        const r = i.getAttribute(n.MODAL_COMPONENT_REF_ATTRIB);
        if (!r)
            return s.DevLogger.error(`The following L2Modal element appears to be missing the dynamically applied ${n.MODAL_COMPONENT_REF_ATTRIB} attribute`, i),
            null;
...
, function(e, t, i) {
    ...
    class h extends a.default {
        ...
        _createModal(e, t) {
            if (!e)
                return this.logger.error("An L2Modal for the following L1 element is unable to find the required content wrapper element", this.el),
                {};
...
, function(e, t, i) {
    ...
    t.default = {
        ...
        _attachTimelineCompleteEvents() {
            ...
            e.on("update", (t=>{
                e.paused() || (0 === e.progress() && e.reversed() && this._onCloseComplete(),
        ...
        _getAnimatedStyles() {
            return new Promise(((e,t)=>{
                try {
                    ...
                    n.DevLogger.error("Something went wrong retrieving starting values for L2Modal Open/Close animated styles"),
                    t(e)
                }
            }
            ))
        ...
        _setupScrimAnimation() {
            const {duration: e, ease: t} = this._openCloseSharedKfOpts
              ...
              , c = d.addKeyframe(this.elements.container, {
                start: 0,
                end: e,
                alpha: [0, l],
                blur: [0, h, "px"],
            ...
            (0,
            s.draw)((()=>{
                this.elements.container.style.setProperty(r.SCRIM.CSS_VAR_FILL, `rgba(${o}, 0)`),
        ...
        _setupContentEnhancedAnimation() {
            const {duration: e, ease: t} = this._openCloseSharedKfOpts
              ...
              , s = "100vh"
              , n = i.addKeyframe(this.elements.contentContainer, {
                start: 0,
                end: e,
                opacity: [1, 1],
                y: [s, 0],
    ...
    e.exports = {
            ...
            this._items.forEach(((e,t)=>{
                if (t > 1) {
                    ...
                    for (let e = t; e > 1; e--) {
                        ...
                        s += ") * (1 - css(--photos-slide-gallery-scale-start, a0))) * " + (this.isRTL ? 1 : -1),
                        i.push(s)
                    }
        ...
        generateBuildInKeyframes() {
            ...
            this._items.forEach(((e,t)=>{
                ...
                t > this.model.startIndex && (r = `(a${n + 1}r - r - (a${n + 1}w - w)) ${this.isRTL ? "-" : "+"} abs(${s}) + 50a${n + 1}w * (1 - css(--photos-slide-gallery-scale-start, a${n + 2})) - (${this.isRTL ? "50w" : `w - a${n + 1}w`}) * css(--photos-slide-gallery-scale-start, a ${n + 2})`),
        ...
        _destroyBuildIn() {
            ...
            !this.isEnhanced && this.buildInTimeline.keyframeControllers && this.buildInTimeline.keyframeControllers.forEach((e=>{
...
, function(e, t, i) {
    ...
    class a extends n.default {
        ...
        onUnenhance() {
            this.viewerUseStandardGallery && (this._anchorEl.setAttribute("href", this._data.defaultPath),
              ...
              , t = Object.assign({}, {
                ...
                onEventOnce: ()=>{
                    this.loadKfTimeoutHandler = setTimeout((()=>{
                        this.asapScrollKeyframe && !this.asapScrollKeyframe.destroyed && this.asapScrollKeyframe.remove(),
...
, function(e, t, i) {
    ...
    class d {
        ...
        createLoader() {
            ...
            this.scenesData ? this.gallery.classList.add(h) : this.loaderIndicator.style.setProperty("--progress", "-100%")
        }
        ...
        async createScene() {
            ...
            this.scene.frameReady.then((()=>{
                ...
                this.gallery.classList.remove(h)) : (this.scene.loader.removeEventListener("load", this.onProgress),
                ...
                this.hideLoaderTimeout = setTimeout((()=>{
                    ...
                    this.loaderIndicator.style.setProperty("--progress", "-100%")
                }
                ), 950)
            }
            )))
    ...
    t.default = class extends d {
        ...
        async createLayerModel() {
            ...
            this.pointer.onPointerTest = e=>{
                ...
                return t && this.camera.enable && !this.sizeCameraDisable ? this.camera.enable() : this.camera.disable && this.camera.disable(),
                t
            }
        }
        ...
        _onAnimationEnd(e) {
            ...
            "hint" === e.animation && this.introCamera.removeEventListener("animation:update", this._onAnimationUpdate),
            "intro" !== e.animation && "hint" !== e.animation || (this.mainCamera._proposedPositionTheta = 180)
        }
        onPointerStart() {
        ...
        createScrollAnimation() {
            ...
            this.ANIMATION.scroll) {
                ...
                this.switchCamera(this.introCamera),
                this.introTimeline = this.introCamera.createTimeline("intro"),
                this.introTriggerEvent = n.default.addEvent(this.element, Object.assign(this.ANIMATION.intro || {
                    start: "t-50vh"
                }, {
                    disabledWhen: ["no-enhanced"],
                    onEvent: ()=>{
        ...
        onSizeChange(e) {
            ...
            requestAnimationFrame((()=>{
                ...
                this.mainCamera.changeState("default", (()=>{
                    this.mainCamera._theta > 250 ? this.mainCamera._closestXAngle = 360 : this.mainCamera._theta < 110 && (this.mainCamera._closestXAngle = 0),
        ...
        checkCameraAngle(e) {
            ...
            Math.abs(this.mainCamera._closestXAngle - i) < 1 && Math.abs(this.mainCamera._closestYAngle - t) < 1 && (cancelAnimationFrame(this.loopRAF),
            this.transitionSize(),
        ...
        transitionSize() {
            (0,
            l.SizeAnimationCases)(this.ANIMATION, this.interpolation.angle, this.models, this.bboxes)
        }
    }
}
, function(e, t, i) {
                ...
                beforeCreate() {
                    ...
                    this.featureObserver = ((e,t)=>{
                        ...
                        const s = new MutationObserver((e=>{
                            for (const s of e)
                                "class" === s.attributeName && i !== s.target.className && (i = s.target.className,
                                t())
                        }
                        ));
                        return s.observe(e, {
...
, function(e, t, i) {
    ...
    class o extends n.default {
        ...
        constructor(e) {
            ...
            this.destroyed = !document.documentElement.classList.contains(r.RT_VIEWER_FEATURE_DETECT),
...
, function(e, t, i) {
    ...
    class a extends n.default {
        ...
        _setupTimeGroups() {
            ...
            (0,
            r.setDefaultDismissKeyframes)(this.dismiss, this.background, this.backgroundBounds),
...
, function(e, t, i) {
    ...
    class c extends r.default {
        constructor(e) {
            ...
            this.aaps = [],
            this.modal = null,
            this.aapElements = document.querySelectorAll(`[data-modal-name="${this.el.dataset.modalName}-modal"] [data-aap-level="2"]`),
            this.isAnimating = !1
        }
        mounted() {
            this.aapElements.forEach((e=>{
        ...
        setupEvents() {
            ...
            this.anim.on(`modal-created-${this.el.dataset.modalName}`, (e=>{
                ...
                e.on("open", (()=>{
                    ...
                    this.aaps.forEach((e=>{
                        const t = e.preload;
                        e.isEnhanced() && (e.needsUpdate && "3d-viewer" !== e.aap.dataset.aapType && t && e.initEnhanced(),
                        requestAnimationFrame((()=>{
                            e.aap.style.opacity = "0",
                            e.inRange && !e.needsUpdate && "3d-viewer" !== e.aap.dataset.aapType && t && (e.isAnimating = !0,
                            e.introduceTimeline())
                        }
                        )))
                    }
                ...
                e.on("close", (()=>{
                    this.aaps.forEach((e=>{
                        e.reset && e.reset(),
                        e.isEnhanced() && (e.aap.classList.add("inactive"),
                        e.isAnimating = !1,
                        e.isActive = !1,
                        e.dismiss.pause(),
                        e.introduce.pause(),
    ...
    class l extends n.default {
        ...
        _onDrag(e) {
            ...
            this.dragDrawId = a((()=>{
                ...
                this.toggleOptions[this.nextIndex].dispatchEvent(this.changeEvent),
                this.target = 0,
                this.bubbleHintOffset = 0) : (this.target < -56 || this.swipeVelocity < -50) && this.toggleOptions[this.prevIndex] ? (this.toggleOptions[this.prevIndex].checked = !0,
                this.toggleOptions[this.prevIndex].dispatchEvent(this.changeEvent),
                this.target = 0,
                this.bubbleHintOffset = 0) : this.target > 0 && this.toggleOptions[this.nextIndex] || this.target < 0 && this.toggleOptions[this.prevIndex] ? (this.bubbleHintOffset = this.target / 56 * 4,
                this.aapOffset = 0,
                this.container.style.setProperty("--aap-offset", `${this.aapOffset}`)) : (this.bubbleHintOffset = 0,
                this.aapOffset = this.target / 56 * 2,
                this.container.style.setProperty("--aap-offset", `${this.aapOffset}`)),
...
, function(e, t, i) {
    ...
    class o extends n.default {
        constructor(e) {
            ...
            this._scrollGroup = this.modal.animScrollGroup) : (this._scrollGroup = this.anim.createScrollGroup(this.el),
            ...
            this.addDiscreteEvent({
                ...
                onEvent: ()=>{
                    this.digitWrappers.forEach(((e,i)=>{
                        this.applyTranslateValue({
                            currentNum: t,
                            decimalPlace: this.digitWrappers.length - i,
                            wrapperIndex: i
                        })
                    }
                    )),
