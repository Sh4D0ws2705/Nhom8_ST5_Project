        ...
        <form action="/cart/send" method="POST">
            <div class="row">
                <div class="col-md-8 cart" style="max-height: 700px; overflow: scroll;">
                        ...
                        <div class="row border-top border-bottom">
                            <div class="row main align-items-center">
                                ...
                                <div class="col product-qty">
                                    <input class='form-control text-center me-3' name="product_id[{{$product->maSP}}]" style='max-width: 4rem' type="number"
                                        value="{{ Session::get('cart')[$product->maSP] }}" min="1">
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-2">
                            <!-- Placeholder để tạo khoảng cách giữa số tiền và tổng tiền -->
                        </div>
                        <div class="col-10">
                            <div class="row">
                                <div class="col-5">
                    ...
                    <div class="back-to-shop"><a href=" {{ url('/home') }}">&leftarrow;<span class="text-muted">Back to shop</span></a></div>
                </div>
