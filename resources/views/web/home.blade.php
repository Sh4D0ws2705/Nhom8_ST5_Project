            ...
            <div class="row">
                ...
                <div class="display-header d-flex justify-content-between pb-3">
                    <h2 class="display-7 text-dark text-uppercase"
                        style="margin-left: calc(50% - 50px); font-weight:bold; margin-bottom: 30px">Mobile Products
                    </h2>
                    <div class="btn-right">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="swiper-slide" style="height:500px; width: 300px;">
                                    <div class="product-card position-relative">
                                        <div class="image-holder">
                                            <a href="{{ route('detail')}}?id={{ $row->sanphams->maSP }}"><img
                                                    style="width:300px; height: 200px;"
                                                    src="{{ asset('frontend/images/image-db/' . $row->anhDaiDien) }}"
                                                    alt="product-item" class="img-fluid"></a>
                                        </div>
                                        ...
                                        <h3 class="card-title text-uppercase tendm">
                                            <a href="{{ route('show.page',['page'=>'detail']) }}">
                                                <h4
                                                    style="line-height: 30px; font-weight:bolder;font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; margin-top: 20px">
                                        ...
                                        <div
                                            class="card-detail d-flex justify-content-center align-items-baseline pt-3">
                                        ...
                                        <br>
                                        <span
                                            class="item-price text-primary status">{{ $row->trangthaisps->TrangThai }}</span>
                                    </div>
                                </div>
                            </div>
                            @endforeach
