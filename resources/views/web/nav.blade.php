    ...
    <header id="header" class="site-header header-scrolled position-fixed text-black bg-light">
        <nav id="header-nav" class="navbar navbar-expand-lg px-3 mb-3">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('show.page',['page'=>'home']) }}">
                        ...
                        <ul id="navbar"
                            ...
                            <li class="nav-item">
                                <a class="nav-link me-4 active"
                                    href="{{ route('show.page',['page'=>'home']) }}">Home</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li>
                                    ...
                                    @if($row->active == 1)
                                    <li>
                                        <a href="{{ route('category.products', ['idDanhMuc' => $row->idDanhMuc]) }}"
                                            class="dropdown-item">
                                            {{ $row->tenDanhMuc }}
                                        </a>
                                    </li>
                                    ...
                                    @endforeach
                                    <li>
                                        <a href="{{ route('show.page',['page'=>'googlemap']) }}"
