...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px" data-bs-smooth-scroll="true"
    ...
    @section('navbar')
            ...
            <div class="container">
                <div class="row" style="width: 1531px; transform: translate(-109px, 0px);">
                    ...
                    <div class="display-header d-flex justify-content-between pb-3">
                        <h2 class="display-7 text-dark text-uppercase">{{ $danhMuc->tenDanhMuc }}</h2>
                    </div>
        ...
        <script>
            ! function(e) {
                ...
                class a extends s {
                    ...
                    void 0 === this.controller.tweenProps.targetStyles && (this.controller.tweenProps
                        .targetStyles = {})
                }
                ...
                s.prototype.parseOptions.call(this, e),
                    ...
                    void 0 === this.controller.tweenProps[this.friendlyName] && (this.controller.tweenProps[
                        this.friendlyName] = new r(0, 1, !1, this.friendlyName)),
                    this.keyframeType = n.KeyframeTypes.CSSClass
            }
            updateLocalProgress(e) {
                this.isApplied && !this.toggle || (this.start !== this.end ? !this.isApplied && e >= this
                    .start && e <= this.end ? this._apply() : this.isApplied && this.toggle && (e < this
                        .start || e > this.end) && this._unapply() : !this.isApplied && e >= this
                    .start ? this._apply() : this.isApplied && this.toggle && e < this.start && this
                    ._unapply())
            }
            _apply() {
        ...
        const s = i(71),
            ...
            u = i(162),
            m = {};
        "undefined" != typeof window && (m.create = i(14),
            m.update = i(9),
            m.draw = i(1));
        let p = 0;
        e.exports = class extends s {
            ...
            destroy() {
                ...
                this.keyframeControllers = null,
                    ...
                    this.anim = null,
                    this.element._animInfo && this.element._animInfo.group === this && (this.element
                        ._animInfo.group = null,
            ...
            removeKeyframeController(e) {
                return e.destroyed || !this.keyframeControllers.includes(e) ? Promise.resolve() : (e
                    ._allKeyframes.forEach((e => e.markedForRemoval = !0)),
            ...
            clear() {
                return Promise.all(this.keyframeControllers.map((e => this.removeKeyframeController(
                    e))))
            }
            setupRAFEmitter(e) {
            ...
            addEvent(e, t) {
                ...
                return i ? (t.onEnterOnce && s.controller.once(t.event + ":enter", t.onEnterOnce),
                        ...
                        t.onExit && s.controller.on(t.event + ":exit", t.onExit)) : (t.onEventOnce && s
                        .controller.once(t.event, t.onEventOnce),
                        t.onEventReverseOnce && s.controller.once(t.event + ":reverse", t
                            .onEventReverseOnce),
            ...
            updateBounds() {
                ...
                i - t < a.pageMetrics.windowHeight ? (e.min = this.convertScrollPositionToTValue(t -
                            .5 * a.pageMetrics.windowHeight),
                        e.max = this.convertScrollPositionToTValue(i + .5 * a.pageMetrics.windowHeight)
                        ) : (e.min -= .001,
                        e.max += .001),
            ...
            updateProgress(e) {
                this.hasDuration() ? (this.position.localUnclamped = (e - this.viewableRange.a) / (this
                        .viewableRange.d - this.viewableRange.a),
                    this.position.local = n.clamp(this.position.localUnclamped, this.boundsMin, this
                        .boundsMax)) : this.position.local = this.position.localUnclamped = 0
            }
            performTimelineDispatch() {
                ...
                this.trigger(a.EVENTS.ON_TIMELINE_UPDATE, this.position.local),
                    ...
                    this.timelineUpdateRequired = !1,
                    this.position.lastPosition !== this.position.local && (this.position.lastPosition <=
                        this.boundsMin && this.position.localUnclamped > this.boundsMin ? (this.trigger(
                                a.EVENTS.ON_TIMELINE_START, this),
                            this.trigger("start", this)) : this.position.lastPosition >= this
                        .boundsMin && this.position.localUnclamped < this.boundsMin ? (this.trigger(a
                                .EVENTS.ON_TIMELINE_START + ":reverse", this),
                            this.trigger("start:reverse", this)) : this.position.lastPosition <= this
                        .boundsMax && this.position.localUnclamped >= this.boundsMax ? (this.trigger(a
                                .EVENTS.ON_TIMELINE_COMPLETE, this),
                            this.trigger("complete", this)) : this.position.lastPosition >= this
                        .boundsMax && this.position.localUnclamped < this.boundsMax && (this.trigger(a
                                .EVENTS.ON_TIMELINE_COMPLETE + ":reverse", this),
            ...
            updateTimeline(e) {
                ...
                let t = this.position.lastPosition === this.boundsMin || this.position.lastPosition ===
                    this.boundsMax,
                    i = this.position.localUnclamped === this.boundsMin || this.position
                    .localUnclamped === this.boundsMax;
                ...
                if (this.timelineUpdateRequired || this.position.localUnclamped > this.boundsMin && this
                    .position.localUnclamped < this.boundsMax)
                    return this.performTimelineDispatch(),
                        this.requestDOMChange(),
                        void(this.position.lastPosition = this.position.localUnclamped);
                let s = this.position.lastPosition > this.boundsMin && this.position.lastPosition < this
                    .boundsMax,
                    n = this.position.localUnclamped <= this.boundsMin || this.position
                    .localUnclamped >= this.boundsMax;
                if (s && n)
                    return this.performTimelineDispatch(),
                        this.requestDOMChange(),
                        void(this.position.lastPosition = this.position.localUnclamped);
                const r = this.position.lastPosition < this.boundsMin && this.position.localUnclamped >
                    this.boundsMax,
                    a = this.position.lastPosition > this.boundsMax && this.position.localUnclamped <
                    this.boundsMax;
            ...
            convertScrollPositionToTValue(e) {
                return this.hasDuration() ? n.map(e, this.viewableRange.a, this.viewableRange.d, 0, 1) :
                    0
            }
            convertTValueToScrollPosition(e) {
                return this.hasDuration() ? n.map(e, 0, 1, this.viewableRange.a, this.viewableRange.d) :
                    0
            }
            hasDuration() {
            ...
            _addKeyframesToImages() {
                this._scrollGroup = this.AnimSystem.getScrollGroupForTarget(document.body),
                    this._images.forEach((e => {
                        this.AnimSystem.getScrollGroupForTarget(e) && (this._scrollGroup = this
                            .AnimSystem.getScrollGroupForTarget(e));
                        const t = this._defineKeyframeOptions(e);
                        if (e.closest(`[${r.CONTENT_WRAPPER_ATTRIB}]`))
                            e[a] = t;
                        else {
                            this._scrollGroup.addKeyframe(e, t).controller.on(
                                "AnimLazyImage:enter", (() => {
        ...
        class o extends s {
            ...
            _setupListeners(e) {
                if (e !== o.CHANGE_EVENTS.RETINA || this.listenersAdded.retina || (window.matchMedia(r)
                        .addListener(this._onRetinaChange),
                        this.listenersAdded.retina = !0),
                    e !== o.CHANGE_EVENTS.ORIENTATION || this.listenersAdded.orientation || (window
                        .matchMedia(a).addListener(this._onOrientationChange),
        ...
        e.exports = {
            itemsCreated() {
                ...
                t > -1 && (this.currentIndex = t,
                    this.model.InitialIndexFromHashLink.ScrollReset && this
                    ._resetHorizontalScrollPosition())
            },
            _resetHorizontalScrollPosition(e) {
                const t = e || this.el;
                0 !== t.scrollLeft ? t.scrollLeft = 0 : t !== document.body && this
                    ._resetHorizontalScrollPosition(t.parentNode)
            }
        }
    }, function(e, t, i) {
        "use strict";
        ...
        "use strict";
        e.exports = function(e, t) {
            e.exitSpotlightPosition = function() {},
        ...
        e.exports = {
            created(e) {
                this.analytics = {
                    ...
                    observer: null,
                    name: this.el.getAttribute("data-analytics-gallery-id") || this.el.getAttribute(
                        "id"),
                    events: {
                        UPDATE: "update",
            ...
            mounted() {
                s && (this.analytics.name || (console.warn(
            ...
            onItemChangeCompleted(e) {
                if (!e.previous || e.current === this.analytics.lastTrackedItem || e.current === e
                    .previous && !this.analytics.lastTrackedItem)
                    return;
        ...
        class p extends r.default {
            async mounted() {
                ...
                this.isL2 && (this.modal = (0,
                        d.getModalComponentRef)(this.gum, this.el)),
            ...
            addFallbackClassname() {
                this.componentEl.classList.add(c.FALLBACK_CLASSNAME),
                    (0,
                        n.draw)((() => this.gum.anim.forceUpdate()))
            }
            mediaLoadError() {
            ...
            mediaUnloaded() {
                this.el.classList.add("media-unloaded"),
                    this.addFallbackClassname()
            }
            injectPlugins(e) {
                ...
                for (const t in e)
                    i.add(t),
                    a.Media.addPlugin(t, e[t]);
                this.videoEl.setAttribute("data-inline-media-plugins", [...i].join(","))
            }
            injectPluginsByAttribute() {
                if (!this.productPagePlugins)
                    throw Error(
                        "InlineMedia: injectPluginsByAttribute(): this.productPagePlugins must be assigned"
                        );
                ...
                if (e && "" !== e) {
                    ...
                    e.split(",").forEach((e => {
                        ...
                        if (!t.includes(s) || i.includes(s)) {
                            if (!i.includes(s))
                                throw Error(`InlineMedia: plugin missing: ${s}`);
            ...
            setupModalController() {
                ...
                this._mediaPlayingOnModalOpen = !1,
                    this.modal.modal.on("open", (() => {
                        "playing" === e.playbackState && (this._mediaPlayingOnModalOpen = !0,
                            e.el.pause())
                    })),
            ...
            destroy() {
                this.mediaInstance && !this.mediaInstance[0]._destroyed && (this.mediaInstance[0].off(c
                        .EVT_TIMEOUT, this.mediaTimeout),
        ...
        n._bindEvents = function() {
            ...
            n.detect = function(e) {
                this._createElements(),
                    ...
                    this.isDetecting || (window.ResizeObserver ? (this.resizeObserver = new ResizeObserver(this
                                ._onResize),
                            this.resizeObserver.observe(this.span)) : this.iframe.contentWindow
                        .addEventListener("resize", this._onResize),
                        this.isDetecting = !0)
            },
            n._resize = function() {
                this.currentSize = parseFloat(window.getComputedStyle(this.span)["font-size"]),
                    this.originalSize < this.currentSize ? document.documentElement.classList.add("text-zoom") :
        ...
        "use strict";
        let s = ["borderRadius", "bottom", "fontSize", "fontWeight", "height", "left", "lineHeight",
            "marginBottom", "marginLeft", "marginRight", "marginTop", "maxHeight", "maxWidth", "opacity",
            "paddingBottom", "paddingLeft", "paddingRight", "paddingTop", "right", "top", "width", "zIndex",
            "strokeDashoffset"
        ];
        s.push(...s.map((e => e.replace(/[A-Z]/g, (e => "-" + e.toLowerCase())))));
        e.exports = {
            transformAttributes: ["x", "y", "z", "scale", "scaleX", "scaleY", "rotation", "rotationX",
                "rotationY", "rotationZ"
            ],
            cssAttributes: s,
            domAttributes: ["scrollLeft", "scrollTop", "scrollBy", "scrollTo", "currentTime"],
            suffixFreeAttributes: ["opacity", "z-index", "font-weight", "zIndex", "fontWeight",
                "scrollLeft", "scrollTop", "scrollBy", "scrollTo", "currentTime"
            ]
        }
    }, function(e, t, i) {
        "use strict";
        ...
        class a extends s {
            ...
            parseOptions(e) {
                e.x = void 0,
                    ...
                    void 0 === this.controller.tweenProps[this.event] && (this.controller.tweenProps[this
                        .event] = new r(0, 1, !1, this.event)),
            ...
            updateLocalProgress(e) {
                if (this.hasDuration) {
                    ...
                    return this.isCurrentlyInRange = i,
                        void(i && !t ? this._trigger(this.event + ":enter") : t && !i && this._trigger(this
                            .event + ":exit"))
                }!this.isApplied && e >= this.start ? (this.isApplied = !0,
                    this._trigger(this.event)) : this.isApplied && e < this.start && (this.isApplied = !
                    1,
        ...
        class r {
            ...
            parseExpression(e, t) {
                ...
                return this.data.target = e.controller.element,
                    ...
                    this.group.anim.plugins.parser.reduce(((i, s) => i || s.parseExpression.call(this, e,
                        t)), null) || r._parse(t, this.data)
            }
            parseTimeValue(e, t) {
                if ("number" == typeof t)
                    return t;
        ...
        e.exports = class extends s {
            ...
            update(e, t, i) {
                ...
                return s < this.epsilon && (this.current = new Float32Array(this.target),
                        s = 0),
                    s > this.epsilon || 0 === s && this.previousValue.some(((e, t) => e !== this
                        .current[t]))
            }
            reconcile(e, t) {
        ...
        e.exports = class {
            ...
            addChapter(e) {
                ...
                return this.chapters.sort(((e, t) => e.start - t.start)).forEach(((e, t) => e.index =
                        t)),
            ...
            playToChapter(e) {
                ...
                return this.tween = this.timeGroup.anim.addTween({
                        ...
                        time: [r, a],
                        onStart: () => {
                            this.destroyed || this.timeGroup.trigger(s.EVENTS
        ...
        class o extends s {
            constructor(e) {
                ...
                super(),
                    ...
                    this.attribute = this.componentAttribute.replace(/-./g, (e => e[1].toUpperCase()))
                    .replace(/data(.)/, ((e, t) => t.toLowerCase())),
                    this.components = [],
                    this.componentsInitialized = !1,
                    this.el.getAttribute("data-anim-scroll-group") || this.el.setAttribute(
            ...
            initComponents() {
                const e = Array.prototype.slice.call(this.el.querySelectorAll(
            ...
            addComponent(e) {
                ...
                if (!r.hasOwnProperty(i))
                    throw "BubbleGum::addComponent could not add component to '" + t.className +
                        "'. No component type '" + i + "' found!";
                const n = r[i];
                if (!o.componentIsSupported(n, i))
                    return void 0 === a[i] && (console.log(
                                "BubbleGum::addComponent unsupported component '" + i + "'. Reason: '" + i +
            ...
            removeComponent(e) {
                ...
                1 !== t && (this.components.splice(t, 1),
                    e.el.dataset[this.attribute] = e.el.dataset[this.attribute].split(" ").filter((t =>
                        t !== e.componentName)).join(" "),
                    e.destroy())
            }
            ...
            static componentIsSupported(e, t) {
                ...
                if ("function" != typeof i)
                    return console.error('BubbleGum::addComponent error in "' + t +
                            '".IS_SUPPORTED - it should be a function which returns true/false'),
                        !0;
                const s = e.IS_SUPPORTED();
                return void 0 === s ? (console.error('BubbleGum::addComponent error in "' + t +
                        '".IS_SUPPORTED - it should be a function which returns true/false'),
                    !0) : s
            }
        }
        ...
        class s {
            ...
            _addKeyframesToImages() {
                this._scrollGroup = this.AnimSystem.getGroupForTarget(document.body),
                    this._images.forEach((e => {
                        this.AnimSystem.getGroupForTarget(e) && (this._scrollGroup = this.AnimSystem
                            .getGroupForTarget(e));
            ...
            _cleanUpImageAttributes(e) {
                let t = !1;
                try {
                    t = this._scrollGroup.getControllerForTarget(e).getNearestKeyframeForAttribute(
                        "AnimLazyImage").isCurrentlyInRange
                } catch (e) {
                    t = !1
                }
            ...
            _findAnim() {
                ...
                return e.map((e => e._animInfo ? e._animInfo.group : null)).filter((e => null !== e)),
                    e[0] && e[0]._animInfo ? e[0]._animInfo.group.anim : (console.error(
        ...
        class a extends s.PictureLazyLoading {
            _addKeyframesToImages() {
                this._pictures.forEach((e => {
                    e.__scrollGroup = this.AnimSystem.getScrollGroupForTarget(document
                        .body),
                        this.AnimSystem.getScrollGroupForTarget(e) && (e.__scrollGroup =
                            this.AnimSystem.getScrollGroupForTarget(e));
                    const t = this._defineKeyframeOptions(e);
                    if (e.closest(`[${n.CONTENT_WRAPPER_ATTRIB}]`))
                        e[r.LAZY_LOAD_STORED_OPTIONS_NAME] = t;
                    else {
                        e.__scrollGroup.addKeyframe(e, t).controller.once(
                            "PictureLazyLoading:enter", (() => {
                                this._imageIsInLoadRange(e)
                            }))
                    }
                }))
        ...
        "use strict";
        e.exports = {
            selectors: ["input", "select", "textarea", "button", "optgroup", "option", "menuitem",
                "fieldset", "object", "a[href]", "[tabindex]", "[contenteditable]"
            ].join(","),
            nodeName: {
                INPUT: "input",
                SELECT: "select",
        ...
        c._setTabbingByIndex = function(e) {
            ...
            c.setSelectedItemByIndex = function(e, t) {
                isNaN(this.selectedNavitemIndex) || this._disableElement(this._navItems[this
            ...
            c.addNavItem = function(e) {
                e && e.nodeType && this._navItems.indexOf(e) < 0 && (o(e.getAttribute(s.DISABLED)) || this
                    ._disableElement(e),
        ...
        c._setup = function() {
                for (var e = [h.ARROW_DOWN, h.ARROW_RIGHT], t = [h.ARROW_UP, h.ARROW_LEFT], i = [h.ENTER, h
                        .SPACEBAR
                    ], s = 0; s < e.length; s++)
            ...
            c._setupNavItems = function() {
                if (this._navItems.length) {
                    ...
                    void 0 !== this.focusedNavItemIndex && void 0 !== this.selectedNavitemIndex || this
                        .setSelectedItemByIndex(0, !0)
                }
            },
            c._setTabbingByIndex = function(e) {
                var t = this._navItems[e];
            ...
            c.selectOption = function(e, t) {
                ...
                i > -1 && document.activeElement !== this._navItems[this.focusedNavItemIndex] && (this
                        .focusedNavItemIndex = i),
                    this._allowMultiSelection ? this._toggleState() : (this._navItems[this.selectedNavitemIndex]
                        .setAttribute(this._state, "false"),
            ...
            c._toggleState = function() {
                ...
                r(e) ? this._navItems[this.focusedNavItemIndex].setAttribute(this._state, "false") : this
                    ._navItems[this.focusedNavItemIndex].setAttribute(this._state, "true")
            },
            c._calculateIndex = function(e, t) {
                var i = t;
                if (!0 === e) {
                    if (i = ++i >= this._navItems.length ? 0 : i,
                        !r(this._navItems[i].getAttribute(l.DISABLED)) || this._navItems[i].hasAttribute(
                            "disabled"))
                        return i
            ...
            c.setSelectedItemByIndex = function(e, t) {
                this._allowMultiSelection || isNaN(this.selectedNavitemIndex) || this._navItems[this
                        .selectedNavitemIndex].setAttribute(this._state, "false"),
            ...
            c.addNavkey = function(e, t) {
                "function" == typeof t && "number" == typeof e ? this._navKeys[e] = t : console.warn(
                    "incorrect types arguments were passed")
            },
        ...
        class c extends n.default {
            constructor() {
                ...
                super(),
                    ...
                    this.id = e.id || this.el.id || this.el.dataset.inlineMediaId || "inlineMedia-" +
                    d++;
        ...
        class l extends a.default {
            constructor(e) {
                super(e),
                    ...
                    this._scrollGroup = this.options.scrollGroup || this._anim.getGroupForTarget(this
                        ._container || this.media.el),
                    this._initialize()
            }
            _initialize() {
                ...
                e.event || (e.event = "inline-media-load-kf"),
                    ...
                    this._loadKeyframe.controller.on(`${this._loadKeyframe.event}:enter`, this
                        ._onLoadKeyframeEnter),
                    this._loadKeyframe.controller.on(`${this._loadKeyframe.event}:exit`, this
                        ._onLoadKeyframeExit)
            }
            get loadKeyframe() {
            ...
            destroy() {
                this._loadKeyframe.controller.off(`${this._loadKeyframe.event}:enter`, this
                        ._onLoadKeyframeEnter),
                    this._loadKeyframe.controller.off(`${this._loadKeyframe.event}:exit`, this
                        ._onLoadKeyframeExit),
                    super.destroy()
            }
        }
        ...
        class l extends a.default {
            ...
            _initialize() {
                ...
                t.event || (t.event = "inline-media-play-kf"),
                    ...
                    this._playKeyframe.controller.on(`${this._playKeyframe.event}:enter`, this
                        ._onPlayKeyframeEnter),
                    this._playKeyframe.controller.on(`${this._playKeyframe.event}:exit`, this
                        ._onPlayKeyframeExit),
            ...
            _onPlayKeyframeExit(e) {
                this._inFrame = !1,
                    this._loaded && this.media.el.paused && !this.media.el.ended ? this._paused = !0 :
                    this._pauseOnExit && (this._paused = !1,
                        this.media.el.pause()),
            ...
            destroy() {
                this._playKeyframe.controller.off(`${this._playKeyframe.event}:enter`, this
                        ._onPlayKeyframeEnter),
                    this._playKeyframe.controller.off(`${this._playKeyframe.event}:exit`, this
                        ._onPlayKeyframeExit),
                    this.media.off(n.default.MEDIA_LOAD_START, this._onLoadStart),
        ...
        class l extends r.default {
            ...
            _initialize() {
                ...
                this._breakpointDetect = e.anim ? new o.default(e) : new a.default(e),
                    this._currentTime = 0;
            ...
            _onBreakpointChange() {
                ...
                const e = window.devicePixelRatio > 1 ? `${this._currentBreakpoint}_2x` : this
                    ._currentBreakpoint,
            ...
            async _swapSrc(e) {
                ...
                return this.media.loadingState === n.default.LOADED && (this._currentTime = this.media
                        .el.currentTime),
        ...
        t.default = class {
            ...
            _initialize() {
                this._updateBreakpoint = this._updateBreakpoint.bind(this),
                    ...
                    this._mediaQueries = Object.keys(this._breakpoints).map((e => window.matchMedia(
                        `(min-width: ${this._breakpoints[e]}px)`))),
        ...
        class p extends h.default {
            constructor(e) {
                super(e),
                    this._loadCompleteEvent = e.loadCompleteEvent || d,
            ...
            async load(e) {
                ...
                return e !== this._currentLoadUrl && (this.media.trigger(o.default.MEDIA_LOAD_START),
                        ...
                        this._pendingPromise = new Promise(((t, i) => {
                            this._resolvePendingPromise = () => {
                                ...
                                this.media.el.addEventListener(this._loadCompleteEvent, this
                                    ._onLoaded),
                                r.default.browser.firefox && this._loadCompleteEvent === l
                                .default.CAN_PLAY_THROUGH && this.media.el.addEventListener(l
                                    .default.CAN_PLAY, this._onLoaded),
            ...
            get loadingState() {
                return this.media.el.error ? a.default.ERROR : this.media.el.networkState === m && this
                    .media.el.readyState === c ? a.default.EMPTY : this.media.el.readyState < u ? this
                    .media.el.buffered.length && 0 === this.media.el.buffered.start(0) && this.media.el
                    .buffered.end(0) === this.media.el.duration ? a.default.LOADED : a.default.LOADING :
                    a.default.LOADED
            }
            destroy() {
                this._clearLoadListeners(),
        ...
        class o extends n.Plugin {
            constructor(e) {
                ...
                const t = (0,
                    r.default)(this.media.el.dataset, this.options, "rangeKeyframe", a);
                t.event || (t.event = "inline-media-range-kf"),
                    this._rangeKeyframe = this._scrollGroup.addKeyframe(this.media.el, t),
                    this._rangeKeyframe.controller.on(`${this._rangeKeyframe.event}:enter`, this
                        ._onRangeKeyframeEnter)
            }
            mounted() {
                this.isAtLeastSafari15minor5 = document.documentElement.classList.contains(
                        "safari-15-5-or-up"),
            ...
            destroy() {
                this.removeObjectFitStyles(),
                    ...
                    this._rangeKeyframe.controller && this._rangeKeyframe.controller.off(
                        `${this._rangeKeyframe.event}:enter`, this._onRangeKeyframeEnter),
                    super.destroy()
            }
            applyObjectFitFix() {
                this.isAtLeastSafari15minor5 && (this._anim.on("ON_RESIZE_IMMEDIATE", this
                        ._onResizeImmediate),
                    this.removeObjectFitStyles(),
            ...
            _onResizeImmediate() {
                "loading-empty" !== this.media.loadingState && "loading-error" !== this.media
                    .loadingState && (this._anim.off("ON_RESIZE_IMMEDIATE", this._onResizeImmediate),
        ...
        class r extends n.default {
            destroy() {
                this._loadKeyframe && !this.loadKeyframe.destroyed && (this._loadKeyframe.controller
                    .off(`${this._loadKeyframe.event}:enter`, this._onLoadKeyframeEnter),
                    this._loadKeyframe.controller.off(`${this._loadKeyframe.event}:exit`, this
                        ._onLoadKeyframeExit))
            }
        }
        ...
        class h extends r.default {
            _initialize() {
                ...
                this._retinaEnabled = (0,
                        a.default)(e, this.options, "retinaEnabled", !0),
                    this._anim = this.options.anim,
                    this._componentEl = this.options.componentEl || this.media.el.closest(l
                        .SELECTOR_COMPONENT_CONTAINER),
                    super._initialize()
            }
            _onBreakpointChange() {
                if (this._currentBreakpoint)
                    return this._breakpointDetect && this._breakpointDetect.destroy(),
                        void this._applyFallback();
                this._currentBreakpoint = this._breakpointDetect.breakpoint;
                const e = window.devicePixelRatio > 1 && this._retinaEnabled ?
                    `${this._currentBreakpoint}_2x` : this._currentBreakpoint,
                    t = `${this._basePath}${e}.mp4`;
                this._swapSrc(t)
            }
            _applyFallback() {
                this._componentEl ? this._componentEl.classList.add(l.FALLBACK_CLASSNAME) : o.DevLogger
                    .warn(
                        `ViewportSourceOnce plugin is missing a reference to a containing element: ${this}`
                        ),
                    (0,
                        n.update)((() => {
                        this.media.destroy(),
                            (0,
                                n.draw)((() => this._anim.forceUpdate()))
                    }))
            }
        }
        t.default = h
        ...
        var n = s(i(6)),
            ...
            l = s(i(241)),
            h = s(i(242));
        const d = ["beforeCreate", "created", "beforeMount", "mounted", "onWillOpen", "onOpen", "onWillClose",
                "onClose", "onResizeImmediate", "onBreakpointChange", "onResizeDebounced", "destroy"
            ],
            c = {
                attributes: {}
            };
        class u extends n.default {
            constructor(e) {
                ...
                super(i),
                    ...
                    d.forEach((e => {
                        this[e] = function() {
                            for (var i = arguments.length, s = new Array(i), n = 0; n <
                                i; n++)
                                s[n] = arguments[n];
                            t[`__${e}`] && t[`__${e}`].forEach((e => e.apply(t, s)))
                        }
        ...
        o.start = function(e) {
                ...
                this._firstTabbableElement ? this.el.contains(document.activeElement) || e || (this
                        ._firstTabbableElement.focus(),
                        t = this._firstTabbableElement) : console.warn(
        ...
        const s = i(314),
            ...
            r = !0 === window.matchMedia("(prefers-reduced-motion: reduce)") || !0 === window.matchMedia(
                ...
                void 0 !== s && (this.tween = this.anim.addTween(this.scrollContainer, {
                    ...
                    onComplete: () => {
                        this.currentIndex = e,
                            ...
                            n || (this.scrollContainer.style["scroll-snap-type"] =
                                "x mandatory"),
                            this.scrollContainer.addEventListener("scroll", this.onScroll),
                            this.tween = void 0
                    }
            ...
            cacheSizeInfo() {
                ...
                this._items.forEach(((e, i) => {
                        ...
                        if ("center" === getComputedStyle(e.el).scrollSnapAlign) {
                            ...
                            this.itemOffsets.push(Math.floor(e.el.offsetLeft - this
                                .scrollContainerWidth / 2 + t))
                        } else
                            this.itemOffsets.push(Math.floor(e.el.offsetLeft - t))
                    })),
        ...
        const s = i(318),
            ...
            r = e => {
                ...
                n(e.paddleNav.nextEl, i),
                    n(e.paddleNav.previousEl, s)
            };
        e.exports = {
            mounted() {
        ...
        class l extends n.default {
            ...
            reset() {
                ...
                this.toggleOptions.forEach((i => {
                    if (i.classList.contains("viewer-colornav-value") && i.dataset
                        .defaultColor && !e) {
                        if (!i.classList.contains("viewer-colornav-value--fallback") && this
                            .viewerReady || !this.viewerReady) {
                            i.checked = !0,
                                e = !0;
                            const t = new Event("change");
                            i.dispatchEvent(t)
                        }
                    } else if (i.classList.contains("viewer-sizenav-value") && i.dataset
                        .defaultSize && !t) {
                        i.checked = !0,
                            t = !0;
            ...
            setAria() {
                if (this.viewerReady) {
                    this.viewerLabel.setAttribute("aria-hidden", !1),
                        this.viewerLabelFallback.setAttribute("aria-hidden", !0);
                    ...
                    this.colorNav.querySelectorAll("input").forEach((e => {
                        ...
                        if (i[t.dataset.viewerValue])
                            return void e.setAttribute("aria-label", i[t.dataset
                                .viewerValue]);
                        const s = document.createElement("div"),
                            n = this.viewerLabel.querySelector(
                                `[data-color-value=${e.dataset.viewerValue}][data-size-value=${t.dataset.viewerValue}]`
                                );
                        if (n) {
                    ...
                    this.sizeNav.querySelectorAll("input").forEach((t => {
                        ...
                        if (i[e.dataset.viewerValue])
                            return void t.setAttribute("aria-label", i[e.dataset
                                .viewerValue]);
                        const s = document.createElement("div"),
                            n = this.viewerLabel.querySelector(
                                `[data-color-value=${e.dataset.viewerValue}][data-size-value=${t.dataset.viewerValue}]`
                    ...
                    this.viewerLabel.setAttribute("aria-hidden", !0),
                        this.viewerLabelFallback.setAttribute("aria-hidden", !1);
                    this.colorNav.querySelectorAll("input").forEach((e => {
                        if (e.dataset.fallbackAriaSet)
                            return;
                        const t = document.createElement("div"),
                            i = this.viewerLabelFallback.querySelector(
                                `[data-color-value=${e.dataset.viewerValue}]`);
                        if (i) {
            ...
            loadEnhanced() {
                this.viewerReady = !0,
                    this.aap.classList.add("viewer-loaded"),
                    this.resetAll()
            }
            loadFallback() {
                this.viewerReady = !1,
                    this.aap.classList.remove("viewer-loaded"),
                    this.resetAll(),
                    this.setAria()
            }
            resetAll() {
                this.needsUpdate = !0,
                    ...
                    this.reset(),
                    this.destroy().then((() => {
                        this.isEnhanced() && (this.introduce = this.anim.createTimeGroup(),
                            this.dismiss = this.anim.createTimeGroup(),
                            this.initEnhanced(),
                            this.isAnimating = !1)
                    }))
            ...
            initEnhanced() {
                document.fonts.ready.then((() => {
                    this._getBounds(),
                        this._setupTimeGroups(),
                        this._setupScrollGroup(),
                        this.needsUpdate = !1
                }))
            }
            updateLabel() {
                ...
                this.toggleOptions.forEach((t => {
                        t.checked && (t.classList.contains("viewer-colornav-value") ? e.color =
                            t.dataset.viewerValue : e.size = t.dataset.viewerValue)
                    })),
                    this.viewerLabels.forEach((t => {
                        this.viewerReady ? t.dataset.sizeValue === e.size && t.dataset
                            .colorValue === e.color ? t.classList.add("active") : t.classList
                            .remove("active") : t.dataset.colorValue === e.color ? t.classList
                            .add("active") : t.classList.remove("active")
                    })),
            ...
            _setupSizeToggle() {
                this.sizeNav.querySelectorAll("input").forEach(((e, t) => {
                    e.addEventListener("change", (() => {
                        this.sizeNav.style.setProperty("--bubble-position",
                                `${e.style.getPropertyValue("--option-offset")}`
                                ),
                            this.sizeNav.style.setProperty("--bubble-width",
                                `${e.style.getPropertyValue("--option-width")}`
                                ),
                            e.checked && (this.selected = e,
            ...
            _onDrag(e) {
                ...
                this.inputStart = t,
                    ...
                    o(this.dragDrawId),
                    this.dragDrawId = a((() => {
                        (this.target > 56 || this.swipeVelocity > 50) && this.sizeOptions[this
                                .nextIndex] ? (this.sizeOptions[this.nextIndex].checked = !0,
                                this.sizeOptions[this.nextIndex].dispatchEvent(this
                                .changeEvent),
                                this.target = 0,
                                this.bubbleHintOffset = 0) : (this.target < -56 || this
                                .swipeVelocity < -50) && this.sizeOptions[this.prevIndex] ? (
                                this.sizeOptions[this.prevIndex].checked = !0,
                                this.sizeOptions[this.prevIndex].dispatchEvent(this
                                .changeEvent),
                                this.target = 0,
                                this.bubbleHintOffset = 0) : (this.target > 0 && this
                                .sizeOptions[this.nextIndex] || this.target < 0 && this
                                .sizeOptions[this.prevIndex]) && (this.bubbleHintOffset = this
                                .target / 56 * 4,
                                this.aapOffset = 0,
                                this.sizeNav.style.setProperty("--aap-offset",
                                    `${this.aapOffset}`)),
                            this.sizeNav.style.setProperty("--bubble-hint-position",
                                `${this.bubbleHintOffset}`)
                    }))
            }
            _onStopDrag(e) {
                window.removeEventListener("touchmove", this._onDrag),
                    ...
                    this.dragDrawId = a((() => {
                        this.sizeNav.style.setProperty("--bubble-hint-position",
                                `${this.bubbleHintOffset}`),
                            this.sizeNav.style.setProperty("--aap-offset", `${this.aapOffset}`)
                    }))
            }
            _getBounds() {
                if (this.viewerReady && (this.sizeNav.style.position = "relative",
                        this.sizeNav.style.width = "auto"),
                    ...
                    this.colorNav.style.setProperty("--colornav-width",
                        `${this.colorNavBounds.width}px`),
                    this.viewerReady) {
                    this.sizeNav.style.setProperty("--sizenav-width", `${this.sizeNavBounds.width}px`);
                    const e = this.sizeNav.querySelectorAll("input");
                    e.forEach((e => {
                            "1" === this.ltr ? e.style.setProperty("--option-offset",
                                    `${e.parentNode.offsetLeft}px`) : e.style.setProperty(
                                    "--option-offset", Math.floor(e.parentNode.parentNode
                                        .getBoundingClientRect().right - e.parentNode
                                        .getBoundingClientRect().right) - 1 + "px"),
                                e.style.setProperty("--option-width",
                                    `${e.parentNode.offsetWidth}px`)
                        })),
                        this.sizeNav.style.setProperty("--bubble-position",
                            `${e[0].style.getPropertyValue("--option-offset")}`),
                        this.sizeNav.style.setProperty("--bubble-width",
                            `${e[0].style.getPropertyValue("--option-width")}`),
                        this.sizeNav.style.position = "absolute",
                        this.reset()
                }
            }
            _setupTimeGroups() {
                if (this.dismiss.name = `AAP 3D Viewer: Dismiss - ${this.aap.id}`,
                    this.viewerReady ? (this.dismiss.addKeyframe(this.sizeNavBubble, {
                            start: 0,
                            end: .25,
                            opacity: [1, 0],
                    ...
                    this.viewerReady ? (this.dismiss.addKeyframe(this.colorNav, {
                        ...
                        this.dismiss.addKeyframe(this.sizeNav, {
                            ...
                            x: [`(7px + ${this.colorNavBounds.width - this.sizeNavBounds.width + .5 * this.sizeNavBounds.width}px) * css(--ltr)`,
                                0
                            ],
                            easeFunction: r.AAP_EASE_FUNCTIONS.CUBIC_BEZIER
                        }),
                    ...
                    this.dismiss.on("complete", (() => {
                        this.isAnimating = !1,
                            this.aap.classList.add("inactive"),
                            this.inRange && (this.isAnimating = !0,
                                this.introduceTimeline())
                    })),
                    this.introduce.name = `AAP 3D Viewer: Introduce - ${this.aap.id}`,
                    (0,
                        r.setDefaultIntroduceKeyframes)(this.introduce, this.aap),
                    ...
                    this.introduce.addKeyframe(this.sizeNav, {
                        ...
                        this.introduce.addKeyframe(this.sizeNav, {
                            ...
                            x: [0,
                                `(7px + ${this.colorNavBounds.width - this.sizeNavBounds.width + .5 * this.sizeNavBounds.width}px) * css(--ltr)`],
                            easeFunction: r.AAP_EASE_FUNCTIONS.SPRING
                        });
            ...
            destroy() {
                return this.sizeNav.style.position = "relative",
                    super.destroy()
            }
        }
        t.default = l
        ...
        class a extends n.default {
            constructor(e, t) {
                super(e, t),
                    ...
                    this.paddleNavPrevious = this.paddleNavContainer.querySelector(
            ...
            mounted() {
                super.mounted(),
                    this.isEnhanced() && "1" === this.aapLevel && this.preload && this.initEnhanced()
            }
            initEnhanced() {
                this._getBounds(),
                    this._setupTimeGroups(),
            ...
            updateLabel() {
                requestAnimationFrame((() => {
                    this.activeNumber = this.getActiveNumber(),
                        ...
                        this.activeLabel = [...this.viewerLabels].find((e => e.dataset
                            .itemNumber === this.activeNumber)),
            ...
            _setupTimeGroups() {
                this.dismiss.name = `AAP Standard Gallery: Dismiss - ${this.aap.id}`,
                    ...
                    (0,
                        r.setDefaultIntroduceKeyframes)(this.introduce, this.aap, this.background),
        ...
        t.main = new class {
            constructor() {
                Object.assign(l.default, p.default),
                    ...
                    document.documentElement.style.setProperty("--r-viewport-height", window
                        .innerHeight),
                    this._initialize()
            }
            _initLocalnavFocusManager() {
                const e = document.querySelector(".section-welcome .welcome__lockup"),
                    ...
                    i = [document.querySelector("#ac-localnav .ac-ln-title a"), document.querySelector(
                            "#ac-localnav .ac-ln-action-button a"), document.getElementById(
                            "ac-ln-menustate-open"), document.getElementById("ac-ln-menustate-close"),
                        ...t
                    ].filter((e => !!e)),
                    s = u.CLASS_HIDE_LOCALNAV,
                    n = e ?
                    '{"expression": "a0t - 145px", "anchors":[".section-welcome .welcome__lockup"], "tabindex": 0}' :
                    '{"expression": "a0b - 145px", "anchors":[".section-welcome .welcome"], "tabindex": 0}';
                i.forEach((e => {
                    e.dataset.focusExpression = n,
                        e.dataset.focusEnabledWhen = s
                }))
            }
            _initialize() {
                (0,
                    c.trackPageState)(),
                this.bubbleGum = new o.default(document.body, {
                        anim: r.default
                    }),
                    this.bubbleGum.anim.on(r.default.model.EVENTS.ON_DOM_KEYFRAMES_CREATED, this
            ...
            constructor(e, t, i, s) {
                this.mass = e,
                    ...
                    this.m_zeta < 1 ? (this.m_wd = this.m_w0 * Math.sqrt(1 - this.m_zeta * this.m_zeta),
                        this.m_A = 1,
                        this.m_B = (this.m_zeta * this.m_w0 - this.initialVelocity) / this.m_wd) : (this
                        .m_wd = 0,
                        this.m_A = 1,
                        this.m_B = -this.initialVelocity + this.m_w0)
            }
            solve(e) {
                return 1 - (e = this.m_zeta < 1 ? Math.exp(-e * this.m_zeta * this.m_w0) * (this.m_A * Math
                    .cos(this.m_wd * e) + this.m_B * Math.sin(this.m_wd * e)) : (this.m_A + this
                    .m_B * e) * Math.exp(-e * this.m_w0))
            }
        }
        const a = /\d*\.?\d+/g;
        r.fromCSSString = function(e) {
        ...
        class L {
            ...
            number() {
                ...
                if (null != this.char && "." === this.char)
                    for (e.includes(".") && A("Number appears to contain 2 decimal points", this.text, this
                            .pos),
                        e += this.char,
                        this.advance(); null != this.char && b.DIGIT.test(this.char);)
                        e += this.char,
                        this.advance();
                return "." === e && A("Attempted to parse a number, but found only a decimal point", this
                        .text, this.pos),
                    e.includes(".") ? new I(E, parseFloat(e)) : new I(g, parseInt(e))
            }
            getNextToken() {
                for (; null != this.char;)
        ...
        class D {
            ...
            error(e) {
                A(e, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", this.lexer.text,
                    this.pos)
            }
            consume(e) {
                let t = this.currentToken;
                return t.type === e ? this.pos += 1 : this.error(
                        `Invalid token ${this.currentToken.value}, expected ${e}`),
                    t
            }
            consumeList(e) {
                e.includes(this.currentToken) ? this.pos += 1 : this.error(
            ...
            factor() {
                if (this.currentToken.type === m)
                    return new C(this.consume(m), this.factor());
                if (this.currentToken.type === p)
                    return new C(this.consume(p), this.factor());
                if (this.currentToken.type === g || this.currentToken.type === E) {
                    let e = new P(this.currentToken);
                    if (this.pos += 1,
                        b.OPERATOR.test(this.currentToken.value) || this.currentToken.type === u || this
                        .currentToken.type === y || this.currentToken.type === v)
                        return e;
                    if (this.currentToken.type === d && this.currentToken.value === h)
                        return this.consume(d),
                            new x(e, this.anchorIndex(), this.unit(b.ANY_UNIT));
                    if (this.currentToken.type === d)
                        return "%a" === this.currentToken.value && this.error(
                                "%a is invalid, try removing the %"),
                            new x(e, null, this.unit());
                    this.error("Expected a scaling unit type", "Such as 'h' / 'w'")
                } else {
                    if (b.OBJECT_UNIT.test(this.currentToken.value))
                        return new x(new P(I.ONE), null, this.unit());
                    if (this.currentToken.value === h) {
                        this.consume(d);
                        const e = this.anchorIndex();
                        if (b.OBJECT_UNIT.test(this.currentToken.value))
                            return new x(new P(I.ONE), e, this.unit())
                    } else if (this.currentToken.type === d) {
                        if ("calc" === this.currentToken.value)
                            return this.consume(d),
                                this.expr();
                        if ("css" === this.currentToken.value || "var" === this.currentToken.value ||
            ...
            unit() {
                ...
                if (t.type === d && e.test(t.value))
                    return this.consume(d),
                        new I(d, t.value = t.value.replace(/%(h|w)/, "$1").replace("%", "h"));
            ...
            parse() {
                const e = this.expr();
                return this.currentToken !== I.EOF && this.error(
        ...
        class M {
            ...
            UnaryOp(e) {
                return e.op.type === m ? +this.visit(e.expr) : e.op.type === p ? -this.visit(e.expr) :
                    void 0
            }
            MathOp(e) {
            ...
            unwrapReference(e) {
                return null === e.ref ? l.target : (e.ref.value >= l.anchors.length && console.error(
                        `Not enough anchors supplied for expression ${this.parser.lexer.text}`, l.target
                        ),
        ...
        const {
            ...
            cssAttributes: f,
            domAttributes: _
        } = i(102), g = i(166), E = i(72), y = i(167), v = Math.PI / 180, b = {
            create: i(170),
            rotateX: i(171),
            rotateY: i(172),
            rotateZ: i(173),
        ...
        e.exports = class extends c {
            constructor(e, t) {
                super(),
                    ...
                    this._ownerIsElement ? this.friendlyName = this.element.tagName + "." + Array.from(
                        this.element.classList).join(".") : this.friendlyName = this.element
                    ...
                    this.mat4 = b.create(),
                    this.needsWrite = !0,
                    this.onDOMWriteImp = this._ownerIsElement ? this.onDOMWriteForElement : this
                    .onDOMWriteForObject
            }
            destroy() {
                if (this.element._animInfo) {
                    this.element._animInfo.controller === this && (this.element._animInfo.controller =
                        null);
                    ...
                    if (-1 !== e && this.element._animInfo.controllers.splice(e, 1),
                        ...
                        let e = this.element._animInfo.controllers.find((e => e.group !== e.group.anim
                            .tweenGroup));
            ...
            determineActiveKeyframes(e) {
                ...
                this.attributes.forEach((e => this.tweenProps[e].isActive = !0)),
                    this.cssAttributes = this.attributes.filter((e => f.includes(e) || e.startsWith(
                        "--"))).map((e => this.tweenProps[e])),
                    this.domAttributes = this.attributes.filter((e => _.includes(e))).map((e => this
                        .tweenProps[e]));
                                ...
                                if (i.current = i.target = s,
                                    ...
                                    switch (!0) {
                                        ...
                                        case i instanceof E:
                                            ...
                                            break;
                                        case i instanceof y:
                                            i.unset(i.applyToStyle ? this.element.style : this
                                                .element)
                                    }
                            }
            ...
            onDOMWrite() {
                (this.needsWrite || this.needsClassUpdate || this.needsStyleUpdate) && (this
                    .needsWrite = !1,
                    this.onDOMWriteImp(),
            ...
            onDOMWriteForElement() {
                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.element
                    .style;
                ...
                if (this.needsStyleUpdate) {
                    for (let e in this.tweenProps.targetStyles)
                        null !== this.tweenProps.targetStyles[e] && (this.element.style[e] = this
                            .tweenProps.targetStyles[e]),
                        this.tweenProps.targetStyles[e] = null;
                    this.needsStyleUpdate = !1
                }
                this.needsClassUpdate && (this.tweenProps.targetClasses.add.length > 0 && this.element
                    .classList.add.apply(this.element.classList, this.tweenProps.targetClasses.add),
                    this.tweenProps.targetClasses.remove.length > 0 && this.element.classList.remove
                    .apply(this.element.classList, this.tweenProps.targetClasses.remove),
            ...
            handleStyleTransform() {
                ...
                if (t.z.isActive || t.rotationX.isActive || t.rotationY.isActive) {
                    ...
                    1 === t.scale.current && 1 === t.scaleX.current && 1 === t.scaleY.current || b
                        .scale(i, i, [t.scale.current, t.scale.current, 1]),
                        e.transform = "matrix3d(" + i[0] + "," + i[1] + "," + i[2] + "," + i[3] + "," +
                        i[4] + "," + i[5] + "," + i[6] + "," + i[7] + "," + i[8] + "," + i[9] + "," + i[
                            10] + "," + i[11] + "," + i[12] + "," + i[13] + "," + i[14] + "," + i[15] +
                        ")"
                } else if (t.x.isActive || t.y.isActive || t.rotation.isActive || t.rotationZ
                    .isActive || t.scale.isActive || t.scaleX.isActive || t.scaleY.isActive) {
                    const i = this.mat2d;
                    i[0] = 1,
                        i[1] = 0,
                        i[2] = 0,
                    ...
                    t.scaleX.isActive || t.scaleY.isActive ? (i[0] = i[0] * t.scaleX.current,
                        ...
                        e.transform = "matrix(" + i[0] + ", " + i[1] + ", " + i[2] + ", " + i[3] +
                        ", " + i[4] + ", " + i[5] + ")"
                }
            }
            handleEventDispatch() {
            ...
            updateAnimationConstraints() {
                ...
                this.attributes.forEach((e => {
                        1 !== this.keyframes[e].length && this.keyframes[e].sort(s
                            .KeyframeComparison)
                    })),
            ...
            getTargetComputedStyle() {
                let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                return this._ownerIsElement ? ((e || void 0 === this.group.computedStyleCache[this
                        .uuid]) && (this.group.computedStyleCache[this.uuid] = getComputedStyle(this
                        .element)),
                ...
                for (let e = 0, t = this.attributes.length; e < t; e++) {
                    ...
                    if (!(i[0].keyframeType > s.KeyframeTypes.InterpolationForward))
                        for (let e = 0, s = i.length; e < s; e++) {
                            let n = i[e];
                            null === n.jsonProps[t][0] && (0 === e ? n.jsonProps[t][0] = n.animValues[t]
                                    [0] = this.tweenProps[t].current : n.animValues[t][0] = i[e - 1]
                                    .animValues[t][1]),
                                null === n.jsonProps[t][1] && (n.animValues[t][1] = e === s - 1 ? this
                                    .tweenProps[t].current : i[e + 1].animValues[t][0]),
            ...
            removeKeyframe(e) {
                return e.destroyed || e.controller !== this ? Promise.resolve(null) : (e
                    .markedForRemoval = !0,
                    this.group.keyframesDirty = !0,
                    new Promise((t => {
            ...
            updateAnimation(e, t) {
                return this.group.gui && console.warn(
        ...
        "use strict";
        "undefined" != typeof window && (window.DOMMatrix = window.DOMMatrix || window.WebKitCSSMatrix || window
            .CSSMatrix || window.MSCSSMatrix);
        const s = 180 / Math.PI,
        ...
        function h(e) {
            ...
            if (o(c[0], u) < 0)
                for (let e = 0; e < 3; e++)
                    ...
                    c[e][2] *= -1;
            let f;
            return t[0] = .5 * Math.sqrt(Math.max(1 + c[0][0] - c[1][1] - c[2][2], 0)),
                t[1] = .5 * Math.sqrt(Math.max(1 - c[0][0] + c[1][1] - c[2][2], 0)),
                t[2] = .5 * Math.sqrt(Math.max(1 - c[0][0] - c[1][1] + c[2][2], 0)),
                t[3] = .5 * Math.sqrt(Math.max(1 + c[0][0] + c[1][1] + c[2][2], 0)),
                c[2][1] > c[1][2] && (t[0] = -t[0]),
                c[0][2] > c[2][0] && (t[1] = -t[1]),
                c[1][0] > c[0][1] && (t[2] = -t[2]),
                f = t[0] < .001 && t[0] >= 0 && t[1] < .001 && t[1] >= 0 ? [0, 0, n(180 * Math.atan2(c[0][1], c[
                    0][0]) / Math.PI)] : function(e) {
                    const [t, i, r, a] = e, o = t * t, l = i * i, h = r * r, d = t * i + r * a, c = a * a + o +
                        l + h;
                    return d > .49999 * c ? [0, 2 * Math.atan2(t, a) * s, 90] : d < -.49999 * c ? [0, -2 * Math
                        .atan2(t, a) * s, -90
                    ] : [n(Math.atan2(2 * t * a - 2 * i * r, 1 - 2 * o - 2 * h) * s), n(Math.atan2(2 * i *
                        a - 2 * t * r, 1 - 2 * l - 2 * h) * s), n(Math.asin(2 * t * i + 2 * r * a) * s)]
                }(t), {
                    translation: d,
                    rotation: f,
                    eulerRotation: f,
        ...
        e.exports = class extends s {
            set(e) {
                const t =
                    `rgba(${Math.round(this.current[0])},${Math.round(this.current[1])},${Math.round(this.current[2])},${this.current[3]})`;
                e.setProperty(this.key, t)
            }
            unset(e) {
                e.removeProperty(this.key)
        ...
        } = i(169), o = /^\s*?M[(-?\d)|\s]/, l = /^(inset|circle|ellipse|polygon|path)\(/, h = e => o.test(e),
            d = e => l.test(e);
        e.exports = {
            install(e, t) {
        ...
        class l extends s {
            ...
            onPlayTimeUpdate() {
                ...
                if (this._repeats === l.REPEAT_FOREVER || this._repeats > 0) {
                    ...
                    !this._isReversed && i > this.boundsMax ? (i -= this.boundsMax,
                            ...
                            e = !0),
                        e && (this._repeats = this._repeats === l.REPEAT_FOREVER ? l.REPEAT_FOREVER : this
                            ._repeats - 1)
                }
                this.time(i);
            ...
            updateProgress(e) {
                this.hasDuration() ? (this.position.localUnclamped = e,
                    this.position.local = r.clamp(this.position.localUnclamped, this.boundsMin, this
                        .boundsMax)) : this.position.local = this.position.localUnclamped = 0
            }
            updateBounds() {
                if (0 === this.keyframeControllers.length)
        ...
        e.exports = class extends s {
            ...
            finalizeInit() {
                this.onTimeEmitterUpdate = this.onTimeEmitterUpdate.bind(this),
                    this.removeExpiredKeyframeControllers = this.removeExpiredKeyframeControllers.bind(
                        this),
                    super.finalizeInit()
            }
            destroy() {
            ...
            removeOverlappingProps(e) {
                ...
                for (let s = 0, n = i._allKeyframes.length; s < n; s++) {
                    ...
                    a.length !== r.length ? a.forEach((e => delete n.animValues[e])) : (n
                        .markedForRemoval = !0,
            ...
            onTimeUpdate() {
                for (let e = 0, t = this.keyframes.length; e < t; e++)
                    this.keyframes[e].markedForRemoval || this.keyframes[e].updateLocalProgress(this
                        .position.localUnclamped);
                this.requestDOMChange(),
                    this._timeEmitter.run(),
                    null !== this.gui && this.gui.onScrollUpdate(this.position)
            }
            ...
            removeExpiredKeyframes() {
                ...
                for (; e--;) {
                    ...
                    t.destroyed ? this.keyframes.splice(e, 1) : (t.markedForRemoval && (t.jsonProps
                            .onComplete && 1 === t.localT && (t.controller.eventObject.keyframe = t,
                ...
                this.keyframes.length === t && 0 !== this.keyframes.length || this._timeEmitter.executor
                    .eventEmitter.once("after:draw", this.removeExpiredKeyframeControllers)
            }
            ...
            time(e) {
                if (void 0 === e)
                    return this.position.local;
                this.position.local = this.position.localUnclamped = n.clamp(e, this.boundsMin, this
                        .boundsMax),
                    this.onTimeUpdate()
            }
            performTimelineDispatch() {}
        ...
        class o extends s {
            ...
            _addViewportEvents() {
                ...
                this.viewportEmitterMicro = new n(e),
                    this.viewportEmitterMicro.on(n.CHANGE_EVENTS.VIEWPORT, this
                    ._onBreakpointChangeCallback),
            ...
            _downloadImage(e) {
                return new Promise(((t, i) => {
                    null === e.getAttribute(o.DATA_DOWNLOAD_COMPLETE_ATTRIBUTE) ? null === e
                        .getAttribute(o.DATA_DOWNLOADING_ATTRIBUTE) && this
                        ._waitForBackgroundVisible(e).then((e => this._getBackgroundImageSrc(
                            e))).then((e => this._loadImage(e))).then((() => {
                            r((() => {
                ...
                return new Promise(((t, i) => {
                    a((() => {
                        ...
                        i || (i = window.getComputedStyle(e, !1)),
                            0 !== i.backgroundImage.indexOf("url(") ? t(null) : t(i
            ...
            _addKeyframesToImages() {
                this._pictures.forEach((e => {
                    e.__scrollGroup = this.AnimSystem.getGroupForTarget(document.body),
                        this.AnimSystem.getGroupForTarget(e) && (e.__scrollGroup = this
                            .AnimSystem.getGroupForTarget(e));
                    let t = this._defineKeyframeOptions(e);
                    e.__scrollGroup.addKeyframe(e, t).controller.once(
                        "PictureLazyLoading:enter", (() => {
                            this._imageIsInLoadRange(e)
        ...
        class a extends n.default {
            constructor(e) {
                super(),
                    this._targetEl = e || document.body,
                    this._heightEl = null,
                    this._onResize = this._onResize.bind(this),
                    this.resizeObserver = new ResizeObserver(this._onResize),
                    this.resizeObserver.observe(this.heightEl)
            }
            get heightEl() {
                if (!this._heightEl) {
        ...
        class o extends r.default {
            ...
            _updateFocusTargets() {
                ...
                this._els = Array.from(this._els).map((t => {
                        ...
                        let s = t;
                        if (i.hasOwnProperty("focus-target-child") && (s = t.querySelector(i[
                                    "focus-target-child"]),
            ...
            _parseOptions() {
                this._els.forEach((e => {
                    ...
                    e._focusExpression = t.expression,
                        t.hasOwnProperty("anchors") ? e._focusAnchors = t.anchors.map((e =>
                            document.querySelector(e))) : t.hasOwnProperty(
                            "anchors-closest") && (e._focusAnchors = t["anchors-closest"]
                            .map((t => e.closest(t)))),
                        t.hasOwnProperty("tabindex") && (e._tabIndex = t.tabindex),
                        t.hasOwnProperty("expression-last") && (e._focusExpressionLast = t[
                            "expression-last"]),
                        e._focusDelay = !!t.hasOwnProperty("focus-delay") && t[
                            "focus-delay"]
                }))
            }
            _handleFocus(e) {
                if ("key" !== e.target.dataset.focusMethod)
                    return;
                const t = e.target;
                this.focusOn(t)
            }
            focusOn(e) {
                if (e.hasAttribute(a)) {
                    ...
                    setTimeout((() => {
                            e.hasOwnProperty("_focusExpressionLast") && this._lastPosition > n
                                .default.parse(e._focusExpression, t) ? (window.scrollTo(0, n
                                        .default.parse(e._focusExpressionLast, t)),
                                    this._lastPosition = n.default.parse(e._focusExpressionLast,
                                        t)) : (window.scrollTo(0, n.default.parse(e
                                        ._focusExpression, t)),
                                    this._lastPosition = n.default.parse(e._focusExpression, t)
                                    ),
        ...
        class l extends n.default {
            ...
            constructor(e) {
                super(e),
                    ...
                    "Section - Component - Enhanced" === this.enhancedScrollGroup.name && this.logger
                    .error(`${this.componentName}: rename default scroll group`)
            }
            mounted() {
            ...
            onUnenhance() {
                this.unenhanced || (this.unenhanced = !0,
                    this.highlightsGallery.fallbackToStatic())
            }
        }
        t.default = l
    }, function(e, t, i) {
            ...
            _ = {
                beforeCreate() {
                    this.sectionEle = this.el.closest("section"),
                        this.model.PrefersReducedMotion = document.documentElement.classList.contains(
                            "reduced-motion"),
                ...
                _executePreloadStrategy() {
                    ...
                    "string" == typeof e && e.split(/,\s*/).forEach((e => {
                        ...
                        if (!t)
                            throw new Error(
                                `"${e}" is not a valid preload-strategy. Please select from any of the following values: ${Object.keys(this._preloadStrategies).join(", ")}`
                                );
                        t()
                    }))
                },
                    ...
                    e.forEach(((e, i) => {
                            t[i] = new Promise(((t, i) => {
                                e.addEventListener("progress", (i => {
                                        e.buffered.length && e.buffered.end(0) === e
                                            .duration && t()
                                    })),
                ...
                _setupEvents() {
                    ...
                    this.playPauseButton.addEventListener("click", this._togglePlayPause),
                        ...
                        this.onSlideChangeCompleted((e => {
                            "swipe" !== e.type && "keynav" !== e.type || (this.isTransitioning = !0,
                                this.highlightsTimeGroup.time(6.25 * e.entered.index),
                                this.galleryHasEnded && (this.galleryHasEnded = !1,
                                    this._pauseHighlightsGallery()),
                                requestAnimationFrame((() => {
                                    this.isTransitioning = !1
                                })))
                        }));
                    const i = this.sectionEle.querySelector("[data-films-modal-link]");
                    i && i.addEventListener("click", this._pauseHighlightsGallery),
                        this.galleryContainer.classList.add("media-gallery-initialized"),
                        this._executePreloadStrategy()
                },
                _playHighlightsGallery() {
                    this.galleryHasEnded ? (this.galleryHasEnded = !1,
                            this._resetHighlightsGallery()) : this.playCurrentMediaGalleryItem(),
                        this.isPlaying = !0,
                ...
                _updateAnalytics(e) {
                    this.playPauseButton.setAttribute("data-analytics-title", this.playPauseButton.dataset[
                            `analyticsTitle${e}`]),
                        this.playPauseButton.setAttribute("data-analytics-click", this.playPauseButton.dataset[
                            `analyticsClick${e}`]),
                        this.playPauseButton.setAttribute("aria-label", this.playPauseButton.dataset[
                            `aria${e}`]),
        ...
        const s = i(8).EventEmitterMicro,
            n = {};
        "undefined" != typeof window && (n.draw = i(1),
            n.cancelDraw = i(24));
        e.exports = class extends s {
            constructor(e) {
                super(),
                    ...
                    this.analyticsId = this.el.getAttribute("data-analytics-gallery-item-id") || this.el
                    .getAttribute("id"),
        ...
        e.exports = {
            itemsCreated(e) {
                this.model.options.gum || this._isVue || (this.anim.on("ON_RESIZE_IMMEDIATE", this
                        .onResizeImmediate),
            ...
            destroy() {
                this.model.options.gum || this._isVue || (this.anim.off("ON_RESIZE_IMMEDIATE", this
                        .onResizeImmediate),
        ...
        e.exports = {
            ...
            addRAFLoop(e) {
                ...
                if (!t.every((t => e.hasOwnProperty(t))))
                    return void console.log(
                        "BubbleGum.BaseComponent::addRAFLoop required options are missing: " + t.join(
                            " "));
            ...
            createItems(e) {
                if (this._items.length)
                    ...
                    if (0 === this._items.length) {
                        this._items = [],
                            Array.from(this.el.querySelectorAll(this.model.Item.Selector)).forEach(((e,
                                t) => {
        ...
        e.exports = {
                    ...
                    this._items.forEach((e => {
                        ...
                        this.mountDrawId = a((() => {
                            this.mountDrawId = null,
                                this.position = this.target = this
                                .convertSlideIndexToHorizontalPosition(this
                                    .wrappedIndex(this.currentIndex)),
            ...
            draw() {
                ...
                i < .1 && (this.position = this.target),
                    ...
                    1 !== e && (this.slideContainer.style.transition =
            ...
            wrapSlideItems() {
                this.clampedIndex || this._items.length < 2 || (this.currentItem.x = this
                    .convertSlideIndexToHorizontalPosition(this.currentIndex),
                    this.currentItem.prev.x = this.convertSlideIndexToHorizontalPosition(this
                        .currentIndex - 1),
                    this.currentItem.next.x = this.convertSlideIndexToHorizontalPosition(this
                        .currentIndex + 1))
            },
            onResizeImmediate() {
                this.clip && (this.clip.destroy(),
                    ...
                    this.wrapSlideItems(),
                    this.position = this.target = this.convertSlideIndexToHorizontalPosition(this
                        .currentIndex),
        ...
        e.exports = {
            ...
            mounted() {
                this.inputMoveEventName = this.model.IsTouch ? "touchmove" : "mousemove",
                    ...
                    (this.model.IsTouch || this.model.SwipeDrag.DesktopSwipe) && (this.el
                        .removeEventListener(this.inputDownEvent, this._onStartDrag),
            ...
            _onDrag(e) {
                ...
                this.swipeDrag.inputStart = {
                    ...
                    this.swipeDrag.isDragging || (this.swipeDrag.isDragging = Math.abs(a) > 3 && Math.abs(
                        a) > Math.abs(o)),
                    this.swipeDrag.isDragging && (this.target += a * this.swipeDrag.movementRateMultiplier,
                        ...
                        this.clampedIndex && (this.model.IsRTL ? this.target = Math.max(this.widthOfItem *
                                this.sign * (this._items.length - 1), Math.min(0, this.target)) : this
                            .target = Math.min(this.widthOfItem * (this._items.length - 1), Math.max(0, this
                                .target))),
                        n(this.swipeDrag.dragDrawId),
            ...
            waitingToReachTarget(e) {
                if (Math.abs(this.position - this.target) > .1)
                    return void(this.swipeDrag.waitingToReachTargetDrawId = s((() => this
                        .waitingToReachTarget(e))));
        ...
        e.exports = {
            ...
            onItemChangeCompleted(e) {
                ...
                this.setCurrentItem(t),
                    ...
                    document.activeElement.parentElement.parentElement === t.el.parentElement && t.anchorEl
                    .focus()
            },
            setCurrentItem(e) {
            ...
            destroy() {
                this.tabNav.items.forEach((e => {
                        e.el.classList.remove("current"),
                            e.el = null,
                            e.anchorEl.classList.remove("current"),
                            e.anchorEl.removeEventListener("click", e.onSelected),
                            e.anchorEl = null
                    })),
                    this.tabNav.items = [],
            ...
            handleIntersect(e) {
                e.forEach((e => {
                    this.isInView = e.isIntersecting,
                        e.isIntersecting ? window.addEventListener("keydown", this.onKeyDown) :
                        window.removeEventListener("keydown", this.onKeyDown)
                }))
            },
            onKeyDown(e) {
        ...
        e.exports = {
            ...
            animateToItem(e) {
                if (e = Math.min(Math.max(0, e), this._items.length - 1),
                    this.currentIndex === e)
                    return;
                this.currentIndex = e;
                ...
                t && (t.zIndex = 0),
                    ...
                    s.opacity = 1,
                    s.zIndex = 2,
                    document.activeElement.id && 0 === document.activeElement.id.indexOf(
                        "media-gallery-item-") && document.activeElement.blur(),
                    this.trigger(this.model.Events.ITEM_CHANGE_INITIATED, {
                        gallery: this,
                        next: s
                    }),
        ...
        e.exports = {
            beforeMount() {
                this._actuallyEndedEventName = "ITEM_CHANGE_ACTUALLY_COMPLETED",
                    this._actuallyBegunEventName = "ITEM_CHANGE_ACTUALLY_BEGUN"
            },
            mounted() {
                this.on(this.model.Events.ITEM_CHANGE_COMPLETED, (e => {
                    ...
                    this.lastInteractionEvent && (this.lastInteractionEvent.type ? t = {
                                ...
                                mouseup: "swipe",
                                click: "link"
                            } [this.lastInteractionEvent.type] : this.lastInteractionEvent
                            .event && (t = this.lastInteractionEvent.event)),
                        t || (t = "unknown");
                    let i = null;
                    if ("swipe" === t || !e.previous || e.previous && e.previous.index === e
                        .current.index) {
                        const s = "number" == typeof this._actualPreviousItem;
                        s && (i = this._actualPreviousItem < e.current.index ? "+" : "-"),
                            this.trigger(this._actuallyEndedEventName, {
                                type: t,
                                direction: i,
                        ...
                        const s = "number" == typeof this._actualPreviousItem;
                        s && (i = this._actualPreviousItem < e.current.index ? "+" : "-"),
                            this.trigger(this._actuallyBegunEventName, {
                                type: t,
                                direction: i,
        ...
        e.exports = {
            mounted() {
                this._setWingVisibilityStatus(),
                    ...
                    this.onSlideChangeBegun((e => {
                        this.getMediaGalleryItem(e.exiting.index).exitSpotlightPosition(),
                            e.exiting && this.pauseMediaGalleryItem(e.exiting.index)
                    })),
                    this.onSlideChangeCompleted((e => {
                        e.exited && e.exited.index === e.entered.index || (this.getMediaGalleryItem(
                                e.entered.index).enterSpotlightPosition(),
                            this.isPlaying && this.playCurrentMediaGalleryItem(),
                            e.exited && this.resetOffScreenItems())
                    })),
                    this.fallbackOnMounted && this.fallbackToStatic()
            },
            resetOffScreenItems() {
                let e = [this.currentIndex];
                this.galleryHasVisibleWings && (e.push(this.currentIndex + 1, this.currentIndex - 1),
                        e = e.filter((e => e >= 0 && e < this._mediaGalleryItems.length))),
            ...
            _setWingVisibilityStatus() {
                const e = parseInt(window.getComputedStyle(this.el).getPropertyValue(
                    "--hlts-glry-max-width")) + 2 * parseInt(window.getComputedStyle(this.el)
                    .getPropertyValue("--hlts-glry-slide-gap"));
        ...
        e.exports = function(e, t) {
            s.apply(this, arguments),
                ...
                e.play = function() {
                    e.isFallback || (e.figureEl.classList.add(e.animationStartClassname),
                        e.figureEl.classList.remove("animation-pause"),
                        e.figureEl.classList.add("animation-play"))
                },
                e.pause = function() {
                    e.isFallback || (e.figureEl.classList.remove("animation-play"),
                        e.figureEl.classList.add("animation-pause"))
                },
                e.reset = function() {
                    e.isFallback || (e.figureEl.classList.remove(e.animationStartClassname),
                        e.pause())
                },
                e.showStaticFallback = function() {
                    e.isFallback = !0,
            ...
            s.apply(this, arguments),
                ...
                e.getViewportVideoPath = function() {
                    const t = ["xlarge", "large", "medium", "small"],
                        ...
                        s = (e.originalItem.el.getAttribute("data-media-excluded-viewports") || "").split(
                            /,\s*/);
                    let n = getComputedStyle(e.videoElement).getPropertyValue(
                        "--hlts-glry-current-viewport");
                    for (; s.indexOf(n) > -1 && "small" !== n;)
                        n = t[t.indexOf(n) + 1];
                ...
                e.load = async function() {
                        return e.isFallback ? Promise.resolve() : (e._loadNextItemDeferred(),
                            new Promise(((t, i) => {
                    ...
                    e._loadNextVideoItemNow = function() {
                        const t = this._mediaGalleryItems.slice(e.index + 1).find((e => "video" === e
                        .type));
                        t ? t.load() : this._handleAllVideoItemsPreloaded()
                    }
                    .bind(this),
                    e._loadNextItemDeferred = function() {
                        e.preparingNextItem || (e.preparingNextItem = !0,
                            e.videoElement.addEventListener("progress", (t => {
                                e.videoElement.buffered.length && e.videoElement.buffered.end(
                                    0) === e.videoElement.duration && !e.preloadAborted && e
                                    ._loadNextVideoItemNow()
                            })))
                    },
                    ...
                    e.play = async function() {
                            ...
                            if (e.isFallback)
                                ...
                                t = await i.catch(e.showStaticFallback).then((() => {
                                    e.hasPlayed = !0,
                                        e.startframeEle.classList.add("hide")
                                })).then((() => {
                        ...
                        e.pause = function() {
                            e.isFallback || "playing" === e.inlineMediaInstance.playbackState && e
                                .videoElement.pause()
                        },
                        e.abortLoad = function(t) {
                            e.isFallback || (e.mediaCanPlay = !1,
                                t && (e.videoElement.setAttribute("src", ""),
                                    e.reset()))
                        },
                        e.reset = function() {
                            e.isFallback || e.hasPlayed && (e.originalClassifications.forEach((e => {
                                ...
                                e.mediaCanPlay && (e.pause(),
                                    e.videoElement.currentTime = 0),
                                e.hasPlayed = !1)
                        },
                        e.showStaticFallback = function() {
                            e.isFallback || (e.abortLoad(),
                                e.figureWrapperEle.classList.add("static-fallback-only"),
                                e.staticFallbackEle.classList.remove("hide"),
                                e.isFallback = !0)
                        },
                        e.enterSpotlightPosition = function() {
                            e.mediaCanPlay && (e.pause(),
        ...
        class u extends o.default {
            constructor(e) {
                ...
                this.featureCallbacks = Object.entries(i).map((e => {
                    ...
                    this._featureElement = (s = t("featureElement", d, document
                    .documentElement)) instanceof HTMLElement ? s : document.querySelector(s),
                    this.featureSets = [this._autoplayStates, this._pausedStates, this._disabledStates,
                        this._destroyStates
                    ],
        ...
        class o extends r.default {
            ...
            _onTimerComplete() {
                this.media.trigger(a),
                    this.media.destroy(),
                    this.media.el.parentElement && this.media.el.parentElement.removeChild(this.media
                        .el)
            }
            destroy() {
                clearTimeout(this._timer),
        ...
        class m extends a.default {
            constructor(e) {
                ...
                this._ariaLabels = {
                    ...
                    this._activeAnalytics = Object.values(u).filter((e => this._button.hasAttribute(e +
                            "-play") && this._button.hasAttribute(e + "-pause") || this._button
                        .hasAttribute(e + "-replay")))
            }
            _findButton() {
                ...
                if (!e) {
                    ...
                    for (const i of t)
                        e = "PlayPause" === i.getAttribute("data-inline-media-control") ? i : i
                        .querySelector(`${o}`)
                }
                return e
            }
        ...
        var n = s(i(42)),
            ...
            o = s(i(43)),
            l = s(i(11));
        const h = [a.default.LOADED_DATA, a.default.LOAD_START, a.default.CAN_PLAY, a.default.CAN_PLAY_THROUGH,
                a.default.PLAY, a.default.PLAYING, a.default.PAUSE, a.default.WAITING, a.default.SEEKING, a
                .default.SEEKED, a.default.ERROR, a.default.ENDED
            ],
        ...
        class c extends l.default {
            constructor(e) {
                super(e),
                    ...
                    this.media.id && this._elementsToDecorate.push(...Array.from(document
                        .querySelectorAll(d.replace("{id}", this.media.id))));
        ...
        class l extends r.default {
            ...
            _initialize() {
                this.media.el.playsInline = !0,
                    this.media.el.autoplay && (this._autoPlayTimer = setTimeout((() => this.media
                    .play())))
            }
            async play() {
            ...
            get playbackState() {
                return this.media.el.ended ? n.default.ENDED : this.media.el.paused ? n.default.PAUSED :
                    n.default.PLAYING
            }
            destroy() {
        ...
        (s = a.prototype = Object.create(r.prototype)).setFps = function(e) {
            ...
            s._onRAFEmitterUpdate = function(e) {
                if (0 === this._lastThrottledTime && (this._lastThrottledTime = this._rafEmitter.executor
                        .lastFrameTime),
                    this._delta = e.time - this._lastThrottledTime,
                    !this._fps)
                    throw new TypeError("FPS is not defined.");
                this._currentFps = 1e3 / this._delta,
                    this._currentFps > this._fps ? this._rafEmitter.run() : (this._rafEmitterEvent = Object
                        .assign({}, e),
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function(e, t) {
                ...
                if (!i)
                    return s.DevLogger.warn("The following nested element does not appear to be in a L2Modal",
                            t),
                        null;
                const r = i.getAttribute(n.MODAL_COMPONENT_REF_ATTRIB);
                if (!r)
                    return s.DevLogger.error(
                            `The following L2Modal element appears to be missing the dynamically applied ${n.MODAL_COMPONENT_REF_ATTRIB} attribute`,
                            i),
                        null;
        ...
        class u extends r.default {
            unload() {
                return void 0 === this.media._destroyed && this.media.trigger(a.EVT_UNLOAD),
                    this.media.el.setAttribute("src", ""),
                    this.media.el.load()
            }
            get loadingState() {
                if (this.media.el.error) {
                    return "" === this.media.el.getAttribute("src") && this.media.el.error.code === c ?
                        n.default.LOADED : n.default.ERROR
                }
                return [h, d].includes(this.media.el.networkState) && this.media.el.readyState === o ? n
                    .default.EMPTY : this.media.el.readyState < l ? this.media.el.buffered.length &&
                    0 === this.media.el.buffered.start(0) && this.media.el.buffered.end(0) === this
                    .media.el.duration ? n.default.LOADED : n.default.LOADING : n.default.LOADED
            }
        }
        t.default = u
    }, function(e, t, i) {
            ...
            _createModal(e, t) {
                if (!e)
                    return this.logger.error(
                        "An L2Modal for the following L1 element is unable to find the required content wrapper element",
                        this.el), {};
                const i = e.hasAttribute(l.USE_ANIM_LIFECYCLE_ATTRIB) ? o.AnimLifecycleEvents : {};
                return new(n.default.withMixins(o.AnalyticsScrollDepth, i, o.AnimScrollGroup, o
                    .AriaLabelledby, o.CloseElements, r.Focus, o.GumComponentRefId, r.Keyboard,
                    o.LazyImage, o.ModalId, o.OpenButton, o.OpenCloseAnimation, o
                    .OverwriteModel, o.ScrollBuffer, r.ScrollPosition, o.SosumiLinks))(e, {
                    attributes: {},
                    btnOpen: t
                })
            }
        ...
        t.default = {
            beforeCreate() {
                document.body._animInfo ? (this.anim = document.body._animInfo.group.anim,
                    this._setViewport(this.anim.model.pageMetrics)) : (this.viewportEmitterMicro = new n
                    .default,
            ...
            _setViewport(e) {
                this._viewport = this.anim ? this._getValidViewport(e.breakpoint) : this._getValidViewport(e
                    .viewport)
            },
            _setPreviousViewport(e) {
                this._previousViewport = this.anim ? this._getValidViewport(e.previousBreakpoint) : this
                    ._getValidViewport(e.oldViewport)
            },
            _getValidViewport(e) {
                const t = {
                    X: "L",
        ...
        t.default = {
            ...
            _createElementsFromTemplate() {
                for (const e in this.templates)
                    this.elements[e] = (new DOMParser).parseFromString(this.templates[e], "text/html").body
                    .childNodes[0]
            },
            _setChildElements(e) {
                [...e.children].forEach((e => {
                    this.getModalElementKey(e) && (this.elements[this.getModalElementKey(e)] =
                            e),
                        this._setChildElements(e)
                }))
            },
            _setDialogRoleElement() {
                this.dialogRoleElement || (this.dialogRoleElement = this.elements.container.querySelector(
                    this.model.DialogRole.Selector) || this.elements.container);
            ...
            _setDialogAriaLabel() {
                if (this.elements.content && this.elements.content.dataset.modalDialogLabel) {
                    ...
                    this.dialogRoleElement.hasAttribute("aria-label") || this.dialogRoleElement
                    .hasAttribute("aria-labelledby") || this.dialogRoleElement.setAttribute("aria-label",
                        "Modal")
            }
        }
    }, function(e, t, i) {
        ...
        t.default = {
            created() {
                this.options.gum || this._isVue || (this.anim ? (this.anim.on(this.anim.model.PageEvents
                            .ON_RESIZE_IMMEDIATE, this.onResizeImmediate),
                        this.anim.on(this.anim.model.PageEvents.ON_RESIZE_DEBOUNCED, this
                            .onResizeDebounced),
                        this.anim.on(this.anim.model.PageEvents.ON_BREAKPOINT_CHANGE, this
                            .onBreakpointChange)) : (window.addEventListener("resize", this
                            .onResizeImmediate),
                        this.viewportEmitterMicro.on(this.viewportEmitterMicro.CHANGE_EVENTS.VIEWPORT,
            ...
            destroy() {
                cancelAnimationFrame(this._mountedRaf),
                    this.anim ? (this.anim.off(this.anim.model.PageEvents.ON_RESIZE_IMMEDIATE, this
                            .onResizeImmediate),
                        this.anim.off(this.anim.model.PageEvents.ON_RESIZE_DEBOUNCED, this
                            .onResizeDebounced),
                        this.anim.off(this.anim.model.PageEvents.ON_BREAKPOINT_CHANGE, this
                            .onBreakpointChange)) : (window.removeEventListener("resize", this
                            .onResizeImmediate),
                        this.viewportEmitterMicro.off(this.viewportEmitterMicro.CHANGE_EVENTS.VIEWPORT, this
                            .onBreakpointChange))
            }
        }
    }, function(e, t, i) {
        ...
        t.default = {
            ...
            close(e) {
                this.opened && (e && "click" === e.type && !this.close.elements.includes(e.target) || (this
                    .trigger(this.model.Events.WILLCLOSE),
        ...
        t.default = {
            ...
            appendCloseButton() {
                (this.elements.container.querySelector(this.model.Elements.closeButton.ParentSelector) ||
        ...
        t.default = {
            ...
            mounted() {
                r.default.getTabbableElements(this.dialogRoleElement).length && (this._circularTab = new n
                    .default(this.dialogRoleElement))
            },
            onOpen() {
                ...
                this.dialogRoleElement.removeAttribute("aria-hidden"),
                    ...
                    this._focusTimeout = setTimeout((() => {
                        this.dialogRoleElement.focus({
                            ...
                            requestAnimationFrame((() => {
                                this.elements.container.removeEventListener("scroll", this
                                        .scrollToModalTop),
        ...
        e.exports = class extends s {
            ...
            destroy() {
                return this._context.removeEventListener(r, this._DOMKeyDown, !0),
                    this._context.removeEventListener(a, this._DOMKeyUp, !0),
                    this._keysDown = null,
                    this._context = null,
                    super.destroy(),
                    this
        ...
        e.exports = class {
            constructor(e) {
                ...
                this[r] || (this[r] = this._getKeyCode()),
                    this.location = void 0 !== this.originalEvent.location ? this.originalEvent
                    .location : this.originalEvent.keyLocation
            }
            preventDefault() {
        ...
        function o(e, t) {
            ...
            "string" != typeof e && s.DevLogger.error("Required modal analytics prop3 name not provided"),
                ...
                t = parseInt(t),
                !isNaN(t) && Object.keys(i).includes(t.toString()) || s.DevLogger.error(
        ...
        t.default = {
            beforeCreate() {
                ...
                this._scrollDepthAnalytics = {
                    ...
                    "string" != typeof e && s.DevLogger.error(
            ...
            mounted() {
                const {
                    ...
                    r.createCustomAnimScrollGroup)(this.anim, this.elements.container,
        ...
        t.default = {
            ...
            mounted() {
                ...
                if (this.elements.container.hasAttribute(s.BTN_CLOSE_ATTRIB) && this.elements.close.push(
            ...
            _appendCloseButton() {
                ...
                i.appendChild(this.elements.closeButton),
                    t.appendChild(i)
            },
            _setCloseAriaLabel() {
                if (this.elements.content && this.elements.content.dataset.modalCloseLabel) {
            ...
            a = {
                ...
                onEnterOnce: e => {
                    e.element.removeAttribute(`${r.DATA_ATTRIBUTE}`),
                        e.element.forceLoad ? e.element.forceLoad() : e.element.forceLazyLoad && e.element
                        .forceLazyLoad()
                }
            };
        t.default = {
                    ...
                    ((e, t) => {
                        e.querySelectorAll(`[${r.DATA_ATTRIBUTE}], [data-lazy]`).forEach((e => {
                            ...
                            i ? t.addEvent(e, {
                                ...
                                "LazyImage modal mixin is missing a stored keyframe", e)
                        }))
        ...
        t.default = {
            beforeMount() {
                ...
                if (!this.options.btnOpen || 1 !== e.nodeType)
                    throw new TypeError(
                        `option.btnOpen is required at modal instantiation; modal affected ${this.elements.container}`
                        );
        ...
        t.default = {
            ...
            onWillOpen() {
                ...
                (0,
                    ...
                    (0,
                        ...
                        this._isModalContentScrollable() && (this.elements.contentContainer
            ...
            _onOpenComplete() {
                (0,
                    ...
                    this.elements.container.style.overflow = "",
                        this.elements.contentContainer.style.marginRight = "",
                        this.trigger(r.ANIMATION_EVTS.OPEN_COMPLETE)
                }))
            },
            close(e) {
                this.opened && (e && "click" === e.type && !this.elements.close.includes(e.target) || (this
                    .opened = !1,
            ...
            _attachTimelineCompleteEvents() {
                ...
                e.on("update", (t => {
                    e.paused() || (0 === e.progress() && e.reversed() && this
                    ._onCloseComplete(),
                        1 === e.progress() && (e.reversed() || this._onOpenComplete()))
                }))
            },
            ...
            _getAnimatedStyles() {
                return new Promise(((e, t) => {
                    try {
                        ...
                        n.DevLogger.error(
                                "Something went wrong retrieving starting values for L2Modal Open/Close animated styles"
                                ),
                            t(e)
                    }
                }))
            ...
            _setupScrimAnimation() {
                const {
                    ...
                    ease: t
                        ...
                        scrimBlur: i,
                        scrimFill: n
                    } = this._openCloseAnimTargetValues, a = n.match(/\d+\.*\d*/g), o = a.slice(0, 3)
                .join(), l = a[3], h = parseFloat(i), d = this._openCloseAnimTimeline, c = d.addKeyframe(
                        this.elements.container, {
                            start: 0,
                            end: e,
                            alpha: [0, l],
                ...
                d.on("update", (e => {
                        ...
                        1 === t && (a = n,
                                l = i),
                            this.elements.container.style.setProperty(r.SCRIM.CSS_VAR_FILL, a),
                            this.elements.container.style.setProperty(r.SCRIM.CSS_VAR_BLUR, l)
                    })),
                    (0,
                        s.draw)((() => {
                        this.elements.container.style.setProperty(r.SCRIM.CSS_VAR_FILL,
                                `rgba(${o}, 0)`),
                            this.elements.container.style.setProperty(r.SCRIM.CSS_VAR_BLUR, "0px")
                    }))
            },
            _setupLocalNavAnimation() {
                if (this._reduceOpenCloseAnimation)
                    return;
                const {
                    duration: e
                } = this._openCloseSharedKfOpts, {
            ...
            _setupContentAnimation() {
                this._reduceOpenCloseAnimation ? this._setupContentBaseAnimation() : this
            ...
            _setupContentEnhancedAnimation() {
                const {
                    duration: e,
                    ease: t
                } = this._openCloseSharedKfOpts, i = this._openCloseAnimTimeline, s = "100vh", n = i
                    .addKeyframe(this.elements.contentContainer, {
                        start: 0,
                        end: e,
                        opacity: [1, 1],
                        y: [s, 0],
        ...
        t.default = {
            beforeCreate() {
                ...
                let r =
                    `${s.MODAL_L2_CLASSNAME} ${s.SCRIM.ELEMENT_CLASSNAME} ${s.THEME_CLASSNAME_NAMESPACE}-${e}`;
                var a;
                t && (r = `${r} ${a = t,
                    a.split(/\s+|,+/).join(" ")}`),
                    ...
                    this.model.Elements.contentContainer = {
                        Selector: "[data-modal-element-overlay]",
                        Attributes: {
                            class: "modal-overlay",
            ...
            _saveScrollBarWidth() {
                (0,
                    ...
                    this._scrollBarWidth = window.innerWidth - document.body.clientWidth + "px",
                        (0,
                            s.draw)((() => {
                            document.documentElement.style.setProperty(n
                                .SCROLLBAR_BUFFER_CSS_VAR, this._scrollBarWidth)
                        }))
                }))
            }
        }
        ...
        function r(e) {
            ...
            t ? this.once(n.ANIMATION_EVTS.CLOSE_COMPLETE, (() => {
                this.options.btnOpen && this.options.btnOpen.focus(),
                    i.scrollIntoView({
                        behavior: s
                    })
            })) : i.scrollIntoView({
        ...
        t.default = {
            beforeCreate() {
                this._footnoteLinks = [],
                    ...
                    `${this.model.Close.Selector}, ${n.SOSUMI_FOOTNOTE_LINK_SELECTOR}`,
                    this._onSosumiFootnoteLinkClick = r.bind(this)
            },
            created() {
                this._footnoteLinks = Array.from(this.elements.content.querySelectorAll(
                    `${n.SOSUMI_FOOTNOTE_LINK_SELECTOR}`))
            },
            mounted() {
                this.options.btnOpen && 1 === this.options.btnOpen.nodeType || s.DevLogger.error(
                    `option.btnOpen is required at modal instantiation; modal affected ${this.elements.container}`
                    );
        ...
        class y extends r.default {
            ...
            constructor(e) {
                super(e),
                    ...
                    this.defaultEnhancedViewports = e.viewports || u.ENHANCED_VIEWPORTS,
                    this.disableViewports = e.disableViewports,
                    document.documentElement.classList.add(p, f, _, g)
            }
            get logger() {
                return l.DevLogger
            }
            ...
            async _unenhanceFeature(e) {
                ...
                this.isEnhanced(e) && !t && (this.logger.log("PageXpController: unenhance: ", e),
                    this.isEnhanced() && ((0,
                            o.setCauseForBase)(E[e]),
                        await c.removeFeatureDetectClass(h.FEATURE_ENHANCED),
                        this.anim.trigger(h.EVT_UNENHANCE),
            ...
            _setupTextZoom() {
                this._textZoomResolver = null,
                    ...
                    this._textZoomPromise.then((() => {
                        this.trigger(r.EVT_TEXT_ZOOM),
                            this._removeTextZoomListener()
                    })),
                    this._applyTextZoomListener()
            }
            _applyTextZoomListener() {
                document.documentElement.classList.contains("text-zoom") ? this._textZoomResolver() :
        ...
        class _ extends n.default {
            ...
            _setupGallery() {
                const e = {
                        beforeCreate() {
                            this.model.PrefersReducedMotion = document.documentElement.classList
                                .contains("reduced-motion"),
                                this.model.IsRTL = "rtl" === document.documentElement.getAttribute(
                                    "dir"),
                                this.model.IsTouch = "ontouchstart" in document.documentElement,
        ...
        e.exports = {
            mounted() {
                this.captions = Array.from(this.el.querySelectorAll(".card-caption")),
                    this.captions.length && this.captions.forEach(((e, t) => {
                        t !== this.currentIndex && s(e, !0)
                    }))
            },
            onItemChangeCompleted(e) {
                this.captions.length && (e.previous && s(this.captions[e.previous.index], !0),
                    e.current && s(this.captions[e.current.index], !1))
            }
        }
    }, function(e, t, i) {
        "use strict";
        ...
        e.exports = {
            mounted() {
                this.scrollContainer = this.el.querySelector(".scroll-container"),
                    ...
                    this.cacheSizeInfo(),
                    this.model.startIndex && (this.scrollContainer.scrollLeft = this.itemOffsets[this.model
                        .startIndex]),
                    this.setCurrentIndex(),
                    this.scrollContainer.addEventListener("scroll", this.onScroll)
            },
        ...
        const {
            EVT_UNENHANCE: s
        } = i(7), n = i(7).FEATURE_ENHANCED, r = `no-${n}`;
        e.exports = {
            mounted() {
                this.scrollContainer = this.el.querySelector(".scroll-container"),
                    this.itemContainer = this.el.querySelector(".item-container"),
                    ...
                    this.galleryScrollGroup = this.anim.createScrollGroup(this.scrollContainer, {
                    ...
                    this.isEnhanced ? this.generateBuildInKeyframes() : this
            ...
            generateOpacityScaleKeyframes() {
                ...
                this._items.forEach(((t, i) => {
                    i < e - 1 && (0 === i && this.isRTL ? this.galleryScrollGroup.addKeyframe(t
                                .cardEl, {
                                    start: "a2l - 50a1w + 50a2w",
                                    end: "l - 50a1w + 50w",
                                    opacity: [.3, 1],
                                    anchors: [this.itemContainer, this.scrollContainer, this
                                        ._items[i + 1].el
                                    ]
                            ...
                            this.withCaptions && (0 === i && this.isRTL ? this
                                .galleryScrollGroup.addKeyframe(this.captions[i], {
                        ...
                        0 !== i && (this.isRTL && this.galleryScrollGroup.addKeyframe(t
                            .cardEl, {
                                start: "l - 50a1w + 50w",
                                end: "l - 50a1w + w + 50a2w + css(row-gap, a0)",
                            ...
                            i === e - 1 && this.isRTL ? this.galleryScrollGroup.addKeyframe(t
                                .cardEl, {
                                    start: "l - 50a1w + 50w",
                                    end: "a2l - 50a1w + 50a2w",
                                    opacity: [1, .3],
                            ...
                            this.withCaptions && (i === e - 1 && this.isRTL ? this
                                .galleryScrollGroup.addKeyframe(this.captions[i], {
                                    start: "a1l - 50a0w + 50a1w",
                                    end: "a1l - 50a0w + 50a1w + 25a1w",
                                    opacity: [1, 0],
                        ...
                        if (t > 1) {
                            ...
                            for (let e = t; e > 1; e--) {
                                ...
                                for (let i = t - 1, n = 0; n < i; n++) {
                                    let r = 0;
                                    n <= t - e && (r = 1),
                                        s += `css(--card-width, a${t + 1 - n}) * ${r}`,
                                        n !== i - 1 && (s += " + ")
                                }
                                s += ") * (1 - css(--photos-slide-gallery-scale-start, a0))) * " + (
                                        this.isRTL ? 1 : -1),
                                    i.push(s)
                            }
                            if (this.xPositions.push(i),
                                !this.isRTL)
                                for (let s = t; s > 1; s--) {
            ...
            generateBuildInKeyframes() {
                this.buildInTimeline = this.anim.createTimeGroup(this.el),
                    this._items.forEach(((e, t) => {
                        ...
                        t > this.model.startIndex && (r =
                                `(a${n + 1}r - r - (a${n + 1}w - w)) ${this.isRTL ? "-" : "+"} abs(${s}) + 50a${n + 1}w * (1 - css(--photos-slide-gallery-scale-start, a${n + 2})) - (${this.isRTL ? "50w" : `w - a${n + 1}w`}) * css(--photos-slide-gallery-scale-start, a ${n + 2})`
                                ),
                            this.buildInTimeline.addKeyframe(e.el, {
                                start: 0,
                                end: 1.5,
                                x: [r, 0],
                                easeFunction: "easeOutQuad",
                                anchors: [...this.anchors, this._items[this.model.startIndex]
                                    .el, this.itemContainer
                                ],
                                preserveState: !0
                            }),
                            this.buildInTimeline.addKeyframe(e.cardEl, {
                                ...
                                scale: ["css(--photos-slide-gallery-scale-start, a0) - 0.05",
                                    "css(--photos-slide-gallery-scale-start, a0)"
                                ],
                    ...
                    this.withCaptions && this.buildInTimeline.addKeyframe(this.captions[this.model
                        .startIndex], {
                        start: 1.2,
                        end: 1.5,
                        opacity: [0, 1],
                    ...
                    this.on("build-in-gallery", (() => {
                        this.isEnhanced && (this.scrollContainer.style["scroll-snap-type"] = "none",
            ...
            _destroyBuildIn() {
                this.scrollContainer.style["scroll-snap-type"] = "x mandatory",
                    ...
                    !this.isEnhanced && this.buildInTimeline.keyframeControllers && this.buildInTimeline
                    .keyframeControllers.forEach((e => {
            ...
            _onUnenhancePageXp() {
                this.isEnhanced = !1,
                    this.buildInTimeline && this._destroyBuildIn()
            }
        }
    }, function(e, t, i) {
        "use strict";
        ...
        e.exports = {
            ...
            checkScrollPosition() {
                let e = !0,
                    t = !0;
                0 === this.currentIndex && (t = !1),
                    this.currentIndex === this._items.length - 1 && (e = !1),
                    s(this.paddleNav.nextEl, e),
                    s(this.paddleNav.previousEl, t)
            },
            onPaddleNavSelected(e) {
                const t = e.currentTarget.className.includes("previous") ? -1 : 1;
                this.lastInteractionEvent = e;
        ...
        class a extends r.default {
            ...
            _configurePlusRows() {
                for (let e = 1; e < this._plusGridRowMax + 1; e++)
                    ...
                    this._gridRowConfig[`plus-row-${e}`].cells = this.el.querySelectorAll(
                        `[data-grid-row-${e}]`),
            ...
            _setMaxRowHeights() {
                this._gridColumns.forEach((e => {
                    for (const [t, i] of Object.entries(this._gridRowConfig))
                        t.startsWith("plus-row-") ? e.style.setProperty(`${i.var}`,
                            `minmax(${i.maxHeight}px, max-content)`) : e.style.setProperty(
                            `${i.var}`, `${i.maxHeight}px`)
                }))
            }
            onBreakpointChange() {
                this._equalize()
        ...
        class a extends n.default {
            ...
            constructor(e) {
                super(e),
                    ...
                    this.viewerUseStandardGallery = "true" === this.rtViewerEl.dataset
                    .useStandardGallery,
                    this._color = "",
                    this._size = "",
            ...
            onUnenhance() {
                this.viewerUseStandardGallery && (this._anchorEl.setAttribute("href", this._data
                        .defaultPath),
            ...
            mounted() {
                if (!this._data.aapId)
                    throw Error(`no aap id supplied: ${this.el}`);
                this._addAAPEvents()
            }
            _addAAPEvents() {
                this.anim.on(r.EVT_AAP_COLOR_CHANGED, this._onAapColorChanged),
                    this.anim.on(r.EVT_AAP_SIZE_CHANGED, this._onAapSizeChanged)
            }
            _removeAAPEvents() {
                this.anim.off(r.EVT_AAP_COLOR_CHANGED, this._onAapColorChanged),
                    this.anim.off(r.EVT_AAP_SIZE_CHANGED, this._onAapSizeChanged)
            }
            ...
            _onAapSizeChanged(e) {
                const t = document.documentElement.classList.contains(r.RT_VIEWER_FEATURE_DETECT) ? e
                    .size : "base";
                this._size = t,
                    this._updateTargetPath()
            }
        ...
        class l extends n.default {
            ...
            _addAAPEvents() {
                this.anim.on(r.EVT_AAP_COLOR_CHANGED, this.onAapColorChanged),
                    this.anim.on(r.EVT_AAP_SIZE_CHANGED, this.onAapSizeChanged)
            }
            _removeAAPEvents() {
                this.anim.off(r.EVT_AAP_COLOR_CHANGED, this.onAapColorChanged),
                    this.anim.off(r.EVT_AAP_SIZE_CHANGED, this.onAapSizeChanged)
            }
            mounted() {
                    ...
                    t = Object.assign({}, {
                        ...
                        onEventOnce: () => {
                            this.loadKfTimeoutHandler = setTimeout((() => {
                                this.asapScrollKeyframe && !this.asapScrollKeyframe
                                    .destroyed && this.asapScrollKeyframe.remove(),
                ...
                const i = Object.assign({}, {
                    ...
                    onEventOnce: () => {
                        clearTimeout(this.loadKfTimeoutHandler),
                            this.loadProductViewer()
                    },
                    disabledWhen: [`no-${r.RT_VIEWER_FEATURE_DETECT}`]
                });
            ...
            loadProductViewer() {
                this.isLoading = !0,
                    this.startLoadTimer(),
                    this._addAnimationEvents(),
                    o.ProductViewerWebGLSingleton.created(),
                    o.ProductViewerWebGLSingleton.onCreate()
            }
            onUnenhance() {
            ...
            startLoadTimer() {
                this.stopLoadTimer(),
                    this._fallbackTimer = setTimeout(this.onLoadTimeout, this.loaderTimeout)
            }
            stopLoadTimer() {
                clearTimeout(this._fallbackTimer)
            }
            onLoadTimeout() {
                window.location.search.includes("no-timeout") || this.anim.trigger(r
                    .EVT_RT_VIEWER_ESCAPE, {
            ...
            onAapColorChanged(e) {
                ...
                o.ProductViewerWebGLSingleton.scene.stopHintTimeout(),
                    o.ProductViewerWebGLSingleton.onColorChange(t)
            }
            onAapSizeChanged(e) {
                const {
                    size: t
                ...
                o.ProductViewerWebGLSingleton.scene.stopHintTimeout(),
                    o.ProductViewerWebGLSingleton.onSizeChange(t, 1e3)
            }
            onViewerAnimationStart(e) {}
            onViewerAnimationUpdate(e) {}
            onViewerAnimationEnded(e) {
                "intro" === e.animation && (o.ProductViewerWebGLSingleton.scene.isInteracted ||
                    requestAnimationFrame((() => {
            ...
            onViewerError(e) {
                e && e.causeForBase && (0,
                        a.setCauseForViewerBase)(e.causeForBase),
                    this.onViewerTriggerDestroy()
            }
            onViewerTriggerLoad() {
                this.loadProductViewer()
            ...
            onViewerTriggerDestroy() {
                this.isLoading = !1,
                    this.rtvIsReady = !1,
                    this.stopLoadTimer(),
                    this._removeAnimationEvents(),
                    this._removeAAPEvents(),
                    o.ProductViewerWebGLSingleton.destroy()
            }
        }
        t.default = l
    }, function(e, t, i) {
        ...
        class d {
            ...
            created() {
                this.createElements(),
                    this.createLoader(),
                    this.lotusScript = this.createPromise(),
                    this.lotusInstance = this.createPromise()
            }
            createElements() {
                if (this.gallery = document.querySelector("[data-rt-viewer-id]"),
                ...
                this.DEFAULT_PATH = this.sceneData.rtPath,
                    this.SCENES = JSON.parse(this.sceneData.rtScenes),
                    this.DURATIONS = JSON.parse(this.sceneData.rtDuration),
                    this.PARTS = JSON.parse(this.sceneData.rtParts || {})
            }
            async createLotusScript() {
                if (this.isLotusScriptCreated)
                    return;
                this.isLotusScriptCreated = !0;
                const e = e => new Promise((t => {
                    const i = document.createElement("script");
                    i.src = `${this.DEFAULT_PATH}/scripts/${e}`,
                        i.onload = () => t(),
                        document.body.append(i)
                }));
                await e("vendors-059be3de.js"),
                    await e("vendors-ce960567.js"),
                    await e("main.js");
                const t = i(306).default;
                let s = this.SCENES.default;
                a.touchAvailable() && (s = window.outerWidth <= 884 ? this.SCENES.small : this.SCENES
                .large);
                const n = await window.fetch(`${this.DEFAULT_PATH}/scenes/${s}.json`),
                    r = await n.json();
                this.scenesData = new Map,
                    this.scenesData.set("ProductViewerScene", r),
                    this.scenesClasses = new Map,
                    this.scenesClasses.set("ProductViewerScene", t),
                    this.lotusScript.resolve()
            }
            onCreate() {
            ...
            createLoader() {
                this.onProgress = this.onProgress.bind(this),
                    this.gallery.classList.add(l),
                    this.scenesData ? this.gallery.classList.add(h) : this.loaderIndicator.style
                    .setProperty("--progress", "-100%")
            }
            async createLotusInstance() {
                this.isLotusInstanceCreated || (this.isLotusInstanceCreated = !0,
                    await this.lotusScript,
                    this.lotus = window.Lotus.instance(),
                    this.lotus.tasks._frameThreshold = 1,
                    this.lotus.settings.initialize({
                        FeatureDetect: a,
                        UserAgent: o
                    }),
            ...
            async createScene() {
                ...
                this.scene = await this.lotus.createScene({
                    ...
                    this.scene && (e || this.scene.loader.addEventListener("load", this.onProgress),
                        this.scene.frameReady.then((() => {
                            this.lotus.tasks.tasks.forEach((e => {
                                ...
                                e ? (this.loaderIndicator.style.setProperty("--progress", "0%"),
                                    this.gallery.classList.remove(h)) : (this.scene.loader
                                    .removeEventListener("load", this.onProgress),
                                    this.loaderIndicator.style.setProperty("--progress", "0%")),
                                Object.keys(this.PARTS).forEach((e => {
                                    this.scene.state.set("geo" === e ? "sidefire" : e, this
                                        .PARTS[e] ? "on" : "off")
                                })),
                                n.default.trigger(r.EVT_RT_VIEWER_READY),
                                this.hideLoaderTimeout = setTimeout((() => {
                                    this.gallery.classList.remove(l),
                                        this.loaderIndicator.style.setProperty("--progress",
                                            "-100%")
                                }), 950)
                        })))
            }
            ...
            onSizeChange(e) {
                void 0 === this.previousTarget && (this.previousTarget = "large"),
                    e === this.previousTarget && (this.previousTarget = "large" === e ? "small" : "large",
                        this.scene.onSizeChange(e))
            }
            onColorChange(e) {
        ...
        function r() {
            return ["linear-gradient(to bottom right, #9f9, white)", "linear-gradient(top left, #9f9, white)",
        ...
        function r(e, t) {
            return t = t || "div",
                e in s.getDocument().createElement(t)
        }
        e.exports = n(r),
            e.exports.original = r
    }, function(e, t, i) {
        ...
        e.exports = function(e, t) {
            var i;
            return e = "on" + e,
                t in s || (s[t] = document.createElement(t)),
                e in (i = s[t]) || "setAttribute" in i && (i.setAttribute(e, "return;"),
                    "function" == typeof i[e])
        }
    }, function(e, t, i) {
        "use strict";
        ...
        function r() {
            var e = s.getWindow(),
                t = !1;
            try {
                "sessionStorage" in e && "function" == typeof e.sessionStorage.setItem && (e.sessionStorage
        ...
        function r() {
            return !!s.getDocument().implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image",
                "1.1")
        }
        e.exports = n(r),
            e.exports.original = r
        ...
        function r() {
            var e = s.getDocument().createElement("canvas");
            return "function" == typeof e.getContext && !(!e.getContext("webgl") && !e.getContext(
                "experimental-webgl"))
        }
        e.exports = n(r),
            e.exports.original = r
        ...
        t.default = class extends d {
            async init() {
                ...
                this.HINT_INTERVAL = e,
                    this.analyticsObject = this.productViewer.dataset.rtAcaInteraction && JSON.parse(
                        this.productViewer.dataset.rtAcaInteraction),
                    await this.createLayerModel(),
                    await this.createLayerCamera(),
                    this.createElement(),
                    this._setAnimationEventsAndTriggers = this._setAnimationEventsAndTriggers.bind(
                    this),
                ...
                await this.layersCreated,
                    ...
                    this.pointer.onPointerTest = e => {
                        const t = (() => {
                            ...
                            if (null !== e[0])
                                for (const t of e)
                                    if (this.boundingBoxesUID.includes(t.object.uuid))
                                        return !0;
                            return t
                        })();
                        return t && this.camera.enable && !this.sizeCameraDisable ? this.camera
                        .enable() : this.camera.disable && this.camera.disable(),
                            t
                    }
            }
            async createLayerCamera() {
                ...
                this.introCameraLayer = this.getLayer(e.intro),
                    ...
                    this.interpolation = this.interpolationLayer.scripts.get(
                        "InteractiveCameraInterpolation"),
                    ...
                    n.default.addEvent(this.element, {
                        ...
                        onEvent: () => {
                            this.createScrollAnimation(),
                                this.mainCamera && (this.mainCamera._phi = 89.9,
                                    this.mainCamera._closestYAngle = 89.9,
            ...
            onFrame() {
                if (this.scrollKeyframeCreated) {
                    this.timelineScroll.progress !== this.animation.progress && (this.timelineScroll
            ...
            _onAnimationUpdate(e) {
                ...
                this.mainCamera._theta = t,
                    ...
                    this.scrollEnded || 1 === this.animation.progress && (this.scrollEnded = !0,
                        this.introScrollKeyframe && !this.introScrollKeyframe.destroyed && this
                        .introScrollKeyframe.remove(),
                        this.timelineScroll && this.timelineScroll._timeline && this.timelineScroll
                        .destroy(),
                        this.playIntroAnimation())
            }
            _onAnimationEnd(e) {
                if (this.switchCamera(this.mainCamera),
                    "intro" === e.animation) {
                    if (this.isInteracted)
                        return;
                    this.startHintTimeout()
                }
                "hint" === e.animation && this.introCamera.removeEventListener("animation:update", this
                        ._onAnimationUpdate),
                    "intro" !== e.animation && "hint" !== e.animation || (this.mainCamera
                        ._proposedPositionTheta = 180)
            }
            onPointerStart() {
                !this.isInteracted && this.analyticsObject && (0,
                        a.trackCustomEvent)(n.default, this.analyticsObject),
                    this.isInteracted = !0,
                    ...
                    this.timelineScroll && this.timelineScroll._timeline && this.timelineScroll
                    .destroy(),
                    this.introTriggerEvent && !this.introTriggerEvent.destroyed && this
            ...
            stopIntroAnimation() {
                this.introTimeline && this.introTimeline._timeline && this.introTimeline.destroy(),
                    this.switchCamera(this.mainCamera)
            }
            playHintAnimation() {
                this.switchCamera(this.introCamera),
                    this.stopHintAnimation(),
                    this.hintTimeline = this.introCamera.createTimeline("hint"),
                    this.hintTimeline.play()
            }
            stopHintAnimation() {
                this.hintTimeline && this.hintTimeline._timeline && this.hintTimeline.destroy(),
                    this.switchCamera(this.mainCamera)
            }
            startHintTimeout() {
            ...
            createScrollAnimation() {
                if (this.stopHintTimeout(),
                    this.stopHintAnimation(),
                    this.stopIntroAnimation(),
                    this.introCamera.addEventListener("animation:update", this._onAnimationUpdate),
                    ...
                    this.switchCamera(this.introCamera),
                    this.introTimeline = this.introCamera.createTimeline("intro"),
                    this.introTriggerEvent = n.default.addEvent(this.element, Object.assign(this
                        .ANIMATION.intro || {
                            start: "t-50vh"
                        }, {
                            disabledWhen: ["no-enhanced"],
            ...
            onSizeChange(e) {
                this.isSizeAnimating || (this.isSizeAnimating = !0,
                    this.stopHintTimeout(),
                    this.stopHintAnimation(),
                    this.stopIntroAnimation(),
                    this.scrollEnded || (this.scrollEnded = !0),
                    ...
                    requestAnimationFrame((() => {
                        this.mainCamera.disable && (this.sizeCameraDisable = !0,
                                this.mainCamera.disable()),
                            this.mainCamera.changeState("default", (() => {
                                this.mainCamera._theta > 250 ? this.mainCamera
                                    ._closestXAngle = 360 : this.mainCamera._theta <
                                    110 && (this.mainCamera._closestXAngle = 0),
                                    this.checkCameraAngle(e)
                            }))
                    })))
            }
            checkCameraAngle(e) {
                ...
                Math.abs(this.mainCamera._closestXAngle - i) < 1 && Math.abs(this.mainCamera
                    ._closestYAngle - t) < 1 && (cancelAnimationFrame(this.loopRAF),
                    this.transitionSize(),
                    ...
                    this.sizeTimeout = setTimeout((() => {
                        this.target.hide(),
                            this.mainCamera.enable && (this.sizeCameraDisable = !1,
            ...
            transitionSize() {
                (0,
                    l.SizeAnimationCases)(this.ANIMATION, this.interpolation.angle, this.models, this
                    .bboxes)
            }
        }
    }, function(e, t, i) {
        ...
        class o {
            ...
            onDataChange(e) {
                this._fields && this._fields.destroy(),
                    this._fields = a.create(e, this.scene),
                    this.onValuesChange()
            }
            async onValuesChange() {
                await this.scene.ready,
                    this.camera = this.scene.camera,
                    this.case = this.scene.getObject(this._fields.case)
            }
            onLoop() {
                if (!this.camera || !this.case)
                    return;
                let e = 0;
                ...
                e = a + f * (1 - _) * (m - u),
                    ...
                    this.layer.element.position.z = -h * Math.sin(e) * .5 * 100,
        ...
        } = i(18), a = i(52), o = i(54), l = i(310), h = i(90), d = i(84), c = i(311), {
            FEATURE_ENHANCED: u
        } = i(7), m = {
            beforeCreate() {
                this.model.PrefersReducedMotion = document.documentElement.classList.contains(
        ...
        e.exports = {
            ...
            animateToItem(e) {
                if (this.currentIndex === e || this.currentIndex === this.wrappedIndex(e))
                    return;
                this.el.parentElement.scrollLeft = 0;
                let t = this.model.IsTouch ? "easeOutCubic" : "easeInOutCubic";
                this.clip && this.clip._isPlaying && (t = "easeOutQuint",
                    this.clip.destroy());
            ...
            combine: function(e) {
                const t = "feature_mask_" + Math.random().toString(16).slice(2),
                            ...
                            this.onFeatureChange = this.onFeatureChange.bind(this),
                                this.featureObserver = ((e, t) => {
                                    ...
                                    const s = new MutationObserver((e => {
                                        for (const s of e)
                                            "class" === s.attributeName && i !== s
                                            .target.className && (i = s.target
                                                .className,
                                                t())
                                    }));
                                    return s.observe(e, {
                    ...
                    n = function(t) {
                        ...
                        if (!i)
                            throw Error(`Cannot find mode for current feature. Current Settings ${e}`);
                        return i.mixin
                    },
                    r = function(e, i) {
                        if (e[t][i]) {
                            for (var s = arguments.length, n = new Array(s > 2 ? s - 2 : 0), r = 2; r <
                                s; r++)
                                n[r - 2] = arguments[r];
                ...
                return e.forEach((function(e) {
                        e.mixin || (e.mixin = {}),
                            Object.keys(e.mixin).forEach((e => i[e] = i[e] || function() {
                                for (var t = arguments.length, i = new Array(t), s =
                                    0; s < t; s++)
                                    i[s] = arguments[s];
                                return r(this, e, ...i)
                            }))
        ...
        class o extends n.default {
            ...
            constructor(e) {
                if (super(e),
                    this.featureDetect = r.RT_VIEWER_FEATURE_DETECT,
                    this.destroyed = !document.documentElement.classList.contains(r
                        .RT_VIEWER_FEATURE_DETECT),
                    this.aapId = this.el.dataset.aapId,
                    !this.aapId)
            ...
            mounted() {
                this._aapElements.colornav.forEach((e => e.addEventListener("change", this
                        ._onChangeColor))),
                    this._aapElements.sizenav.forEach((e => e.addEventListener("change", this
                        ._onChangeSize))),
                    this.destroyed && (0,
                        a.trackViewerState)()
            }
            ...
            _onAapMounted(e) {
                this.aap = e,
                    this._aapSizeNav.parentElement.style.pointerEvents = "all",
                    this.destroyed && this._aapShowFallback()
            }
            _aapShowFallback() {
                requestAnimationFrame((() => {
            ...
            _updateCanvasAria() {
                this.destroyed || requestAnimationFrame((() => {
                    ...
                    this._canvasContainerEl.setAttribute("aria-label", e.getAttribute(
                        "aria-label"))
                }))
            }
            _onViewerReady() {
            ...
            _onChangeColor(e) {
                ...
                this._focusWasTriggered || (this._focusWasTriggered = !0,
                        this._focusContainer(e.target)),
                    i || this.logger.warn(
                        "RealTimeViewerConnector : `data-viewer-value` attribute is invalid:", e.target
                        ),
                    this._updateCanvasAria(),
                    this.anim.trigger(r.EVT_AAP_COLOR_CHANGED, {
                        index: t,
                        color: i,
            ...
            _onChangeSize(e) {
                ...
                i || this.logger.warn(
                    ...
                    this._updateCanvasAria(),
                    this.anim.trigger(r.EVT_AAP_SIZE_CHANGED, {
                        index: t,
                        size: i
                    })
            }
            async _softDestroy() {
                this.destroyed || (this.destroyed = !0,
                    await this.unenhanceFeatureClass(),
                    this.anim.forceUpdate(),
                    this._aapShowFallback(),
                    (0,
                        a.trackViewerState)())
            }
        }
        ...
        e.exports = class extends s {
            ...
            _showSlideGallery() {
                this._els.slideGallery.classList.contains("show") || this._els.slideGallery.classList
                    .add("show")
            }
        }
    }, function(e, t, i) {
        ...
        class m extends u.default {
            ...
            _cacheSizeInfo() {
                let e = 0;
                const t = this._els.accordionContent.map((e => e.offsetHeight)).reduce(((e, t) => Math
                    .max(e, t)));
                return e += t,
                    new Promise(((t, i) => {
                        (0,
                        ...
                        itemsCreated() {
                            Object.values(this.items).forEach((e => {
                                e.triggerEl.onkeydown = t => {
                                        e.state !== this.model.Item.States.expanded && e
                                            .state !== this.model.Item.States.expanding || t
                                            .keyCode !== d.default.SPACEBAR && t.keyCode !==
                                            d.default.ENTER || t.preventDefault()
                                    },
        ...
        const s = i(6),
            ...
            r = i(326),
            a = i(327),
            o = ["beforeCreate", "created", "beforeMount", "createItems", "itemsCreated", "mounted",
                "animateItem", "onItemChangeInitiated", "onItemChangeCompleted", "onResizeImmediate",
                "onBreakpointChange", "onResizeDebounced", "destroy"
            ];
        class l extends s {
            constructor(e) {
                var t;
        ...
        const s = i(8).EventEmitterMicro,
            ...
            a = {};
        "undefined" != typeof window && (a.draw = i(1),
            a.cancelDraw = i(24));
        e.exports = class extends s {
            constructor(e) {
                super(),
            ...
            setupItemElements() {
                ...
                t && (this.parentKey = t.dataset.accordionItem,
                    ...
                    this.childKeys.length ? this.tabbableEls = this.trayEl.querySelectorAll(
                        "[data-accordion-trigger]") : this.tabbableEls = n.getTabbableElements(this
                        .trayEl, !1)
            }
            setInitialState() {
                let e = this.model.Item.InitialState;
                this.el.classList.contains(this.model.Item.ExpandedClassName) ? e = this.model.Item
                    .ExpandedClassName : this.el.classList.contains(this.model.Item
                    .CollapsedClassName) && (e = this.model.Item.CollapsedClassName),
                    this.initialState = e,
                    this.state = e,
            ...
            setExpandState() {
                this.el.classList.remove(this.model.Item.AnimatingClassName, this.model.Item
                        .CollapsedClassName),
            ...
            initiateExpand() {
                this.el.classList.remove(this.model.Item.ExpandedClassName, this.model.Item
                        .CollapsedClassName),
        ...
        var s = i(89),
            n = 0,
            r = ["button", "checkbox", "listbox", "option", "menuitem", "menuitemradio", "menuitemcheckbox",
                "tab"
            ],
            a = i(92),
            o = function() {
        ...
        l._bindEvents = function() {
            ...
            l._hoverProxy = function(e, t, i, s) {
                s ? (e.removeEventListener("focus", this._handleHover, !0),
                    ...
                    i && this._removeCallback(e, t, i)) : (e.addEventListener("focus", this._handleHover, !
                        0),
            ...
            l._handleHover = function(e) {
                "focus" === e.type ? e.currentTarget.classList.add("hover") : e.currentTarget.classList.remove(
                        "hover"),
        ...
        e.exports = {
            ...
            itemsCreated() {
                this.model.options.gum || this._isVue || (this.anim ? (this.anim.on("ON_RESIZE_IMMEDIATE",
                            this.onResizeImmediate),
                        this.anim.on("ON_RESIZE_DEBOUNCED", this.onResizeDebounced),
                        this.anim.on("ON_BREAKPOINT_CHANGE", this.onBreakpointChange)) : (window
                        .addEventListener("resize", this.onResizeImmediate),
                        this.viewportEmitterMicro.on(this.viewportEmitterMicro.CHANGE_EVENTS.VIEWPORT,
                            this.onBreakpointChange)),
                    document.fonts.ready.then((() => {
                        this.mounted()
            ...
            destroy() {
                this.anim ? (this.anim.off("ON_RESIZE_IMMEDIATE", this.onResizeImmediate),
                    this.anim.off("ON_RESIZE_DEBOUNCED", this.onResizeDebounced),
                    this.anim.off("ON_BREAKPOINT_CHANGE", this.onBreakpointChange)) : (window
                    .removeEventListener("resize", this.onResizeImmediate),
                    this.viewportEmitterMicro.off(this.viewportEmitterMicro.CHANGE_EVENTS.VIEWPORT, this
                        .onBreakpointChange))
            }
        }
        ...
        e.exports = {
            ...
            _bindAnalyticsItemEvents(e) {
                e.on(this.model.Item.Events.expanded, (() => this.removeItemClickAttribute(e))),
                    e.on(this.model.Item.Events.collapsed, (() => this.setItemClickAttribute(e, this
                        .analytics.clickValues[e.key])))
            },
            _updateToggleAllButtonClickAttribute() {
                this.toggleAllButton && this.toggleAllButton.toggleEls && this.toggleAllButton.toggleEls
                    .forEach((e => {
                        ...
                        r && (r = this._replaceStateString(r, i, s, n),
                            ...
                            a && (a = this._replaceStateString(a, i, s, n),
                                e.setAttribute(this.analytics.attributes.title, a))
                    }))
            },
        ...
        e.exports = {
            ...
            onItemChangeInitiated(e) {
                this.animateHeight.timeoutIDs[e.item.key] = clearTimeout(this.animateHeight.timeoutIDs[e
                    .item.key])
            },
            animateItem(e) {
                const t = e.item,
                ...
                t.setTrayElHeight(t.contentHeight, "px"),
                    ...
                    s && s.isAnimating() && (this.animateHeight.timeoutIDs[s.key] = clearTimeout(this
                            .animateHeight.timeoutIDs[s.key]),
            ...
            mounted() {
                Object.values(this.items).forEach((e => {
                    e.iconEl = e.el.querySelector(this.model.Icon.Selector),
                        this.model.Icon.Template && (e.iconEl.innerHTML = this.model.Icon
                            .Template),
                        e.isExpanded() && e.iconEl.querySelector(this.model.Icon.ShapeSelector)
                        .setAttribute("points", this.model.Icon.Points.expanded),
                        e.iconExpandAnimationEl = e.iconEl.querySelector(this.model.Icon
                            .ExpandAnimationSelector),
                        e.iconCollapseAnimationEl = e.iconEl.querySelector(this.model.Icon
                            .CollapseAnimationSelector)
                }))
            },
            animateItem(e) {
                const t = e.item;
                t.isExpandState() ? t.iconExpandAnimationEl.beginElement() : t.iconCollapseAnimationEl
                    .beginElement()
            }
        }
    }, function(e, t, i) {
        ...
        e.exports = {
            ...
            toggleItem(e) {
                const t = e.currentTarget.parentElement.closest(this.model.Item.Selector).dataset
                    .accordionItem,
                    i = this.items[t];
                this.trigger(this.model.Events.ITEM_CHANGE_INITIATED, {
                    accordion: this,
        ...
        class u extends r.default {
            constructor(e) {
                super(e),
                    this.aaps = [],
                    this.aapElements = this.el.querySelectorAll('[data-aap-level="1"]'),
                    this.isAnimating = !1
            }
            mounted() {
            ...
            initEnhanced() {
                this.scrollGroup = this.anim.createScrollGroup(this.el),
                    this.scrollGroup.name = "AAP L1 Triggers"
            }
            isEnhanced() {
                return document.documentElement.classList.contains(a.FEATURE_ENHANCED)
            }
        ...
        class a extends n.default {
            constructor(e, t) {
                super(e, t, "textDriven"),
                    this.background = this.aap.querySelectorAll(".all-access-pass__background")[0],
                    this.text = this.aap.querySelector(".aap-base__text"),
                    this.icon = this.aap.querySelector(".aap-base__icon")
            }
            mounted() {
                super.mounted(),
                    this.isEnhanced() && this.initEnhanced()
            ...
            _setupTimeGroups() {
                this.dismiss.name = `AAP Base: Dismiss - ${this.aap.id}`,
                    (0,
                        r.setDefaultDismissKeyframes)(this.dismiss, this.background, this
                        .backgroundBounds),
                    this.dismiss.addKeyframe(this.text, {
                        start: 0,
                        end: .25,
                        opacity: [1, 0]
                    }),
                    ...
                    (0,
                        r.setDefaultIntroduceKeyframes)(this.introduce, this.aap, this.background),
                    this.introduce.addKeyframe(this.icon, {
                        start: .7,
                        end: 1,
                        scale: [0, 1],
                        easeFunction: r.AAP_EASE_FUNCTIONS.SPRING
        ...
        class a extends n.default {
            ...
            initEnhanced() {
                requestAnimationFrame((() => {
                    this.isEnhanced() && (this._getBounds(),
                        this._setupTimeGroups(),
                        this._setupScrollGroup())
                }))
            }
            ...
            _setupTimeGroups() {
                this.isEnhanced() && (this.dismiss.name = `AAP Highlights: Dismiss - ${this.aap.id}`,
                    ...
                    this.introduce.addKeyframe(this.playPauseButton, {
                        ...
                        x: [0,
                            `(7px + ${this.backgroundBounds.width}px -\n          css(--aap-min-height) +\n          css(--aap-min-height) * 0.5\n        ) * css(--ltr)`],
                        easeFunction: r.AAP_EASE_FUNCTIONS.SPRING
                    }),
                    this.introduce.addKeyframe(this.background, {
                        start: .7,
            ...
            destroy() {
                return this.playPauseButton.style.position = "relative",
                    requestAnimationFrame((() => {
                        this.playPauseButton.style.transform = "none",
        ...
        class c extends r.default {
            constructor(e) {
                super(e),
                    this.aaps = [],
                    this.modal = null,
                    this.aapElements = document.querySelectorAll(
                        `[data-modal-name="${this.el.dataset.modalName}-modal"] [data-aap-level="2"]`),
                    this.isAnimating = !1
            }
            mounted() {
                this.aapElements.forEach((e => {
                ...
                this.anim.once(a.EVT_UNENHANCE, (() => this.destroy())),
                    this.anim.on(`modal-created-${this.el.dataset.modalName}`, (e => {
                        this.modal = e,
                            ...
                            e.on("open", (() => {
                                this.isEnhanced() && (this.scrollGroup.forceUpdate(),
                                    this.forceResize(),
                                    this.aaps.forEach((e => {
                                        const t = e.preload;
                                        e.isEnhanced() && (e.needsUpdate &&
                                            "3d-viewer" !== e.aap
                                            .dataset.aapType && t && e
                                            .initEnhanced(),
                                            requestAnimationFrame((
                            ...
                            e.on("close", (() => {
                                this.aaps.forEach((e => {
                                    e.reset && e.reset(),
                                        e.isEnhanced() && (e.aap.classList
                                            .add("inactive"),
                                            e.isAnimating = !1,
                                            e.isActive = !1,
                                            e.dismiss.pause(),
                                            e.introduce.pause(),
                                            e.introduce.progress(0))
                                }))
                            }))
                    }))
            }
            ...
            initEnhanced() {
                this.scrollGroup = this.anim.createScrollGroup(this.modal.elements.container, {
                    ...
                    this.scrollGroup.name =
                    `AAP L2 Triggers - ${this.modal.elements.content.dataset.modalName}`
            }
            isEnhanced() {
                return document.documentElement.classList.contains(a.FEATURE_ENHANCED)
            }
        ...
        class a extends n.default {
            constructor(e, t) {
                super(e, t),
                    ...
                    this.playPauseButtonIcon = this.playPauseButton.querySelector(".icons"),
                    this.playPauseButtonProgress = this.playPauseButton.querySelector(
                        ".play-pause-progress"),
            ...
            _setupTimeGroups() {
                this.dismiss.name = `AAP L2 Play / Pause: Dismiss - ${this.aap.id}`,
                    this.dismiss.addKeyframe(this.playPauseButtonProgress, {
                        start: 0,
                        end: .25,
                        opacity: [1, 0],
                        easeFunction: r.AAP_EASE_FUNCTIONS.CUBIC_BEZIER
        ...
        class l extends n.default {
            ...
            _getBounds() {
                this.background.style.transform = "scale(1)",
                    ...
                    this.toggle.style.setProperty("--bubble-position",
                        `${this.toggleOptions[0].style.getPropertyValue("--option-offset")}`),
                    this.toggle.style.setProperty("--bubble-width",
                        `${this.toggleOptions[0].style.getPropertyValue("--option-width")}`)
            }
            _setupToggle() {
                this.toggleOptions.forEach(((e, t) => {
                    e.addEventListener("change", (() => {
            ...
            _onStartDrag(e) {
                !0 != (!e.touches && 1 !== e.which) && (this.lastInteractionEvent = e,
                    this.swipeVelocity = 0,
                    this.inputStart = e.touches[0].screenX,
                    window.addEventListener("touchmove", this._onDrag, {
                        passive: !1
            ...
            _onDrag(e) {
                ...
                this.inputStart = t,
                    ...
                    o(this.dragDrawId),
                    this.dragDrawId = a((() => {
                        (this.target > 56 || this.swipeVelocity > 50) && this.toggleOptions[this
                                .nextIndex] ? (this.toggleOptions[this.nextIndex].checked = !0,
                                this.toggleOptions[this.nextIndex].dispatchEvent(this
                                    .changeEvent),
                                this.target = 0,
                                this.bubbleHintOffset = 0) : (this.target < -56 || this
                                .swipeVelocity < -50) && this.toggleOptions[this.prevIndex] ? (
                                this.toggleOptions[this.prevIndex].checked = !0,
                                this.toggleOptions[this.prevIndex].dispatchEvent(this
                                    .changeEvent),
                                this.target = 0,
                                this.bubbleHintOffset = 0) : this.target > 0 && this
                            .toggleOptions[this.nextIndex] || this.target < 0 && this
                            .toggleOptions[this.prevIndex] ? (this.bubbleHintOffset = this
                                .target / 56 * 4,
                                this.aapOffset = 0,
                                this.container.style.setProperty("--aap-offset",
                                    `${this.aapOffset}`)) : (this.bubbleHintOffset = 0,
                                this.aapOffset = this.target / 56 * 2,
                                this.container.style.setProperty("--aap-offset",
                                    `${this.aapOffset}`)),
                            this.toggle.style.setProperty("--bubble-hint-position",
                                `${this.bubbleHintOffset}`)
                    }))
            }
            _onStopDrag(e) {
            ...
            _setupTimeGroups() {
                this.dismiss.name = `AAP L2 Step Toggle: Dismiss - ${this.aap.id}`,
                    this.dismiss.addKeyframe(this.toggleBubble, {
                        start: 0,
                        end: .25,
                        opacity: [1, 0],
                        easeFunction: r.AAP_EASE_FUNCTIONS.CUBIC_BEZIER
                    ...
                    (0,
                        r.setDefaultIntroduceKeyframes)(this.introduce, this.aap, this.background),
                    this.introduce.addKeyframe(this.toggle, {
                        start: .7,
                        end: 1.3,
                        "--toggle-color": [0, 1],
            ...
            destroy() {
                return this.toggle.style.position = "relative",
                    super.destroy()
            }
        }
        t.default = l
        ...
        class o extends n.default {
            constructor(e) {
                super(e),
                    ...
                    this.isL2 ? (this.modal = (0,
                            a.getModalComponentRef)(this.gum, this.el),
                        this._scrollGroup = this.modal.animScrollGroup) : (this._scrollGroup = this.anim
                        .createScrollGroup(this.el),
                        this._scrollGroup.name = "Device Anim Component")
            }
            mounted() {
        ...
        class o extends n.default {
            ...
            mounted() {
                this._els1 = this.el.querySelectorAll("[data-textanim-1]"),
                    this._els2 = this.el.querySelectorAll("[data-textanim-2]"),
                    this._els3 = this.el.querySelectorAll("[data-textanim-3]");
                const e = {
                        start: "t-75vh",
                        toggle: !0,
                        style: {
        ...
        class l extends n.default {
            addCustomPlugins() {
                this.productPagePlugins = o,
                    this.injectPluginsByAttribute()
            }
        }
        t.default = l
    }, function(e, t, i) {
        ...
        class r extends n.default {
            ...
            _onPlayKeyframeEnter() {
                return !1 === this._playedOnce ? (this._playedOnce = !0,
                    super._onPlayKeyframeEnter()) : null
            }
        }
        t.default = r
    }, function(e, t, i) {
        ...
        class o extends r.default {
            _initialize() {
                ...
                if (this._autoPlayWithReducedMotion = (0,
                    ...
                    !this._autoPlayWithReducedMotion && r.default.prefersReducedMotion)
                    return;
                this._pauseOnExit = (0,
                ...
                const t = (0,
                    n.default)(e, this.options, "playKeyframe", a);
                if (t.event || (t.event = "inline-media-play-kf"),
                    ...
                    this._resetOnExit) {
                    const t = (0,
                        n.default)(e, this.options, "resetKeyframe", a);
                    t.event || (t.event = "inline-media-reset-kf"),
                        this._resetKeyframe = this._scrollGroup.addKeyframe(this.media.el, t),
                        this._resetKeyframe.controller.on(`${this._resetKeyframe.event}:exit`, this
                            ._onResetKeyframe)
                }
            }
            async _onPlayKeyframeEnter(e) {
                if (this._inFrame = !0,
                    !this._paused && (this._loaded || (await this.media.load(),
                        ...
                        this._inFrame))
                    try {
                        this._resetByKeyframe && (await this.media.play(),
                            this._resetByKeyframe = !1)
                    } catch (e) {}
            }
            _onPlayKeyframeExit(e) {
                this._inFrame = !1,
            ...
            _onResetKeyframe(e) {
                this._loaded && this._resetOnExit && (this._resetByKeyframe = !0,
                    this._paused = !1,
                    this.media.el.pause(),
        ...
        class o extends n.Plugin {
            constructor(e) {
                super(e),
                    ...
                    this.media.on(r.default.PLAYBACK_STATE_CHANGE, this._onPlaybackStateChange.bind(
                        this))
            }
            _onPlaybackStateChange() {
                this.media.playbackState === a.default.ENDED && setTimeout((() => this.media.unload()),
                    500)
            }
        }
        t.default = o
        ...
        class l extends n.default {
            constructor(e) {
                super(e),
                    ...
                    this.animationDuration = Number(this.el.getAttribute("data-animation-duration")) ||
                    2,
                    ...
                    this.digitsArray = a,
                    this._els = {
                        statValueWrapper: this.el.querySelector(".stat-value"),
                        statCount: this.el.querySelector(".stat-count"),
                        statContent: this.el.querySelector(".stat-content")
                    }
            }
            mounted() {
                this.createMarkup(),
                    this.digitWrappers.forEach(((e, t) => {
                        this.applyTranslateValue({
                            currentNum: this.countStartValue,
                            decimalPlace: this.digitWrappers.length - t,
                            wrapperIndex: t
                        })
                    }));
            ...
            createMarkup() {
                this.statDigits = String(this._els.statCount.innerText).split("").map(Number),
                    this.statCount = Number(this._els.statCount.innerText),
                    this._els.statCount.innerText = "",
                    this.digitWrappers = [];
                const e = [];
                this.statDigits.forEach(((t, i) => {
                        const {
                            wrapper: s
                        } = this.createDigitsWrapper();
                        s.classList.add(`digit-${t}`),
                            s.setAttribute("aria-hidden", !0),
                            this._els.statCount.appendChild(s),
                            i === this.statDigits.length - 1 && this._els.statContent.classList
                            .add(`last-digit-${t}`),
            ...
            createDigitsWrapper() {
                ...
                return e.classList.add("digits-wrapper"),
                    this.digitsArray.forEach((t => {
                        const i = document.createElement("span");
                        i.classList.add("digit"),
                            i.innerText = t,
                            e.appendChild(i)
                    })), {
                        wrapper: e
                ...
                this.counterTl = this.anim.createTimeGroup(),
                    this.digitWrappers.forEach(((i, s) => {
                        this.addKeyframe({
                            ...
                            this.applyTranslateValue({
                                currentNum: t,
                                decimalPlace: this.digitWrappers.length - s,
                                wrapperIndex: s
                            })
                        }))
                    })),
                    this.addDiscreteEvent({
                        group: this.counterTl,
                        start: this.animationDuration + .05,
                        event: "complete",
                        onEvent: () => {
                            this.digitWrappers.forEach(((e, i) => {
                                    this.applyTranslateValue({
                                        currentNum: t,
                                        decimalPlace: this.digitWrappers
                                            .length - i,
                                        wrapperIndex: i
                                    })
                                })),
